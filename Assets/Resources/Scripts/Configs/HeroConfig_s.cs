...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101008] = new HeroConfig(101008, "黄忠", 1, 30, 90, 64, 93, 247, 210, 1, 10, 17, 22, 1.5f, 75, 0, 3, "弓", null, "矢", "", "shoot", "BulletExplosionGreen", "huangzhong", 3);
            ...
            config[101020] = new HeroConfig(101020, "张松", 1, 21, 65, 89, 46, 200, 240, 1, 10, 17, 15, 0, 33, 0, 3, "扇", null, "", "", "help", "FanExplosion", "zhangsong", 1);
            ...
            config[101040] = new HeroConfig(101040, "刘巴", 1, 11, 33, 78, 24, 135, 290, 1, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "help", "FanExplosion", "liuba", 0);
            ...
            config[102030] = new HeroConfig(102030, "曹植", 1, 21, 64, 83, 67, 214, 300, 2, 10, 17, 15, 0, 42, 0, 3, "扇", null, "", "", "help", "FanExplosion", "caozhi", 2);
            ...
            config[102039] = new HeroConfig(102039, "曹冲", 1, 10, 31, 85, 21, 137, 260, 2, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "help", "FanExplosion", "caochong", 2);
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, 31, 93, 76, 94, 263, 180, 3, 10, 17, 22, 1.5f, 100, 0, 3, "弓", null, "连", "劫", "shoot", "BulletExplosionFire", "ganning", 2);
            config[103004] = new HeroConfig(103004, "太史慈", 1, 30, 90, 65, 93, 248, 230, 3, 10, 17, 22, 1.5f, 77, 0, 3, "弓", null, "雨", "", "shoot", "BulletExplosionFire", "taishici", 2);
            ...
            config[103026] = new HeroConfig(103026, "顾雍", 1, 21, 65, 81, 60, 206, 300, 3, 10, 17, 15, 0, 36, 0, 3, "扇", null, "连", "", "help", "FanExplosion", "guyong", 1);
            ...
            config[103038] = new HeroConfig(103038, "严畯", 1, 20, 62, 82, 48, 192, 290, 3, 10, 17, 15, 0, 28, 0, 3, "扇", null, "", "", "help", "FanExplosion", "yanjun", 1);
            ...
            config[105009] = new HeroConfig(105009, "辛宪英", 1, 14, 42, 84, 28, 154, 310, 5, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "help", "FanExplosion", "xinxianying", 1);
