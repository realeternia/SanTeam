...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101001] = new HeroConfig(101001, "赵云", 1, 30, 91, 76, 96, 263, 300, 1, 10, 17, 0, 0, 100, 0, 1, "马", null, "镜", "", "def", "SwordHitWhiteCritical", "zhaoyun", 4);
            ...
            config[101003] = new HeroConfig(101003, "马超", 1, 30, 92, 54, 97, 243, 315, 1, 10, 17, 0, 0, 70, 0, 1, "马", null, "影", "", "atk", "SwordHitWhiteCritical", "machao", 4);
            config[101004] = new HeroConfig(101004, "诸葛亮", 1, 32, 98, 100, 45, 243, 245, 1, 10, 17, 18, 0, 70, 0, 3, "谋", null, "神", "", "inte", "LightningExplosionYellow", "zhugeliang", 6);
            ...
            config[101017] = new HeroConfig(101017, "庞统", 1, 28, 85, 98, 47, 230, 250, 1, 10, 17, 15, 0, 56, 0, 3, "谋", null, "锁", "", "inte", "ExplosionFireballFire", "pangtong", 1);
            ...
            config[101008] = new HeroConfig(101008, "黄忠", 1, 30, 90, 64, 93, 247, 210, 1, 10, 17, 22, 1.5f, 75, 0, 3, "弓", null, "矢", "", "shoot", "BulletExplosionFire", "huangzhong", 3);
            config[101009] = new HeroConfig(101009, "周仓", 1, 21, 63, 55, 82, 200, 335, 1, 10, 17, 0, 0, 33, 0, 1, "刀", null, "", "", "atk", "SwordHitYellowCritical", "zhoucang", 1);
            ...
            config[101011] = new HeroConfig(101011, "马岱", 1, 26, 80, 66, 85, 231, 300, 1, 10, 17, 0, 0, 57, 0, 1, "马", null, "坚", "", "atk", "SwordHitYellowCritical", "madai", 2);
            ...
            config[101019] = new HeroConfig(101019, "张苞", 1, 25, 75, 82, 87, 244, 305, 1, 10, 17, 0, 0, 71, 0, 1, "枪", null, "奋", "", "atk", "SwordHitYellowCritical", "zhangbao", 2);
            ...
            config[101022] = new HeroConfig(101022, "简雍", 1, 24, 72, 69, 65, 206, 240, 1, 10, 17, 22, 1.5f, 36, 0, 3, "弓", null, "", "", "shoot", "BulletExplosionBlue", "jianyong", 1);
            config[101023] = new HeroConfig(101023, "蒋琬", 1, 21, 64, 85, 52, 201, 240, 1, 10, 17, 18, 0, 33, 0, 3, "相", null, "励", "", "help", "SharpExplosionGreen", "jiangwan", 1);
            config[101024] = new HeroConfig(101024, "孙乾", 1, 20, 62, 80, 54, 196, 250, 1, 10, 17, 35, 0, 31, 0, 3, "鼓", null, "", "", "help", "SoulExplosionOrange", "sunqian", 1);
            ...
            config[101030] = new HeroConfig(101030, "郭攸之", 1, 21, 63, 82, 48, 193, 260, 1, 10, 17, 35, 0, 29, 0, 3, "鼓", null, "励", "", "help", "SoulExplosionOrange", "guoyouzhi", 1);
            config[101031] = new HeroConfig(101031, "马良", 1, 22, 68, 93, 60, 221, 270, 1, 10, 17, 18, 0, 48, 0, 3, "相", null, "", "", "help", "SharpExplosionGreen", "maliang", 1);
            ...
            config[101034] = new HeroConfig(101034, "刘禅", 1, 9, 27, 35, 41, 103, 360, 1, 10, 17, 35, 0, 25, 0, 3, "鼓", null, "", "", "help", "SoulExplosionOrange", "liushan", 3);
            ...
            config[101036] = new HeroConfig(101036, "黄权", 1, 25, 75, 82, 59, 216, 310, 1, 10, 17, 0, 0, 44, 0, 1, "枪", null, "", "", "atk", "SwordHitYellowCritical", "huangquan", 1);
            config[101037] = new HeroConfig(101037, "孟达", 1, 25, 75, 68, 73, 216, 250, 1, 10, 17, 22, 1.5f, 44, 0, 3, "弓", null, "", "", "shoot", "BulletExplosionBlue", "mengda", 0);
            config[101038] = new HeroConfig(101038, "刘封", 1, 25, 75, 44, 79, 198, 310, 1, 10, 17, 0, 0, 32, 0, 1, "刀", null, "", "", "atk", "SwordHitYellowCritical", "liufeng", 1);
            ...
            config[101040] = new HeroConfig(101040, "刘巴", 1, 11, 33, 78, 24, 135, 290, 1, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "inte", "FanExplosion", "liuba", 0);
            ...
            config[102005] = new HeroConfig(102005, "许褚", 1, 21, 65, 44, 96, 205, 390, 2, 10, 17, 0, 0, 36, 0, 1, "士", null, "波", "", "atk", "SwordHitYellowCritical", "xuchu", 2);
            ...
            config[102008] = new HeroConfig(102008, "张郃", 1, 29, 89, 75, 90, 254, 300, 2, 10, 17, 0, 0, 85, 0, 1, "车", null, "透", "", "def", "SwordHitYellowCritical", "zhanghe", 3);
            ...
            config[101033] = new HeroConfig(101033, "法正", 1, 27, 83, 94, 52, 229, 275, 1, 10, 17, 15, 0, 55, 0, 3, "谋", null, "米", "", "inte", "GasExplosionFire", "fazheng", 2);
            ...
            config[102016] = new HeroConfig(102016, "文聘", 1, 26, 80, 65, 82, 227, 335, 2, 10, 17, 0, 0, 53, 0, 1, "戟", null, "", "", "atk", "SwordHitYellowCritical", "wenpin", 1);
            ...
            config[102023] = new HeroConfig(102023, "杨修", 1, 20, 60, 88, 57, 205, 260, 2, 10, 17, 18, 0, 36, 0, 3, "相", null, "", "", "help", "SharpExplosionGreen", "yangxiu", 0);
            config[102024] = new HeroConfig(102024, "牛金", 1, 23, 71, 65, 77, 213, 330, 2, 10, 17, 0, 0, 41, 0, 1, "刀", null, "", "", "atk", "SwordHitYellowCritical", "niujin", 1);
            ...
            config[102026] = new HeroConfig(102026, "曹真", 1, 27, 82, 70, 74, 226, 310, 2, 10, 17, 0, 0, 52, 0, 1, "戟", null, "", "", "def", "SwordHitYellowCritical", "caozhen", 1);
            config[102027] = new HeroConfig(102027, "陈群", 1, 21, 65, 84, 45, 194, 270, 2, 10, 17, 15, 0, 29, 0, 3, "扇", null, "励", "", "help", "FanExplosion", "chenqun", 3);
            ...
            config[102029] = new HeroConfig(102029, "曹丕", 1, 26, 78, 79, 79, 236, 320, 2, 10, 17, 0, 0, 62, 0, 1, "刀", null, "", "", "def", "SwordHitYellowCritical", "caopi", 2);
            config[102030] = new HeroConfig(102030, "曹植", 1, 21, 64, 83, 67, 214, 300, 2, 10, 17, 15, 0, 42, 0, 3, "扇", null, "", "", "inte", "FanExplosion", "caozhi", 2);
            config[102031] = new HeroConfig(102031, "刘晔", 1, 21, 65, 88, 49, 202, 200, 2, 10, 17, 13, 2.5f, 34, 0, 3, "炮", null, "", "", "shoot", "GasMissileFire", "liuye", 1);
            config[102032] = new HeroConfig(102032, "朱灵", 1, 24, 73, 60, 77, 210, 325, 2, 10, 17, 0, 0, 39, 0, 1, "刀", null, "劫", "", "atk", "SwordHitYellowCritical", "zhuling", 0);
            ...
            config[102034] = new HeroConfig(102034, "毌丘俭", 1, 26, 78, 55, 75, 208, 340, 2, 10, 17, 0, 0, 38, 0, 1, "刀", null, "", "", "atk", "SwordHitYellowCritical", "guanqiujian", 1);
            ...
            config[102036] = new HeroConfig(102036, "夏侯尚", 1, 26, 79, 72, 75, 226, 315, 2, 10, 17, 0, 0, 52, 0, 1, "戟", null, "", "", "def", "SwordHitYellowCritical", "xiahoushang", 1);
            ...
            config[102039] = new HeroConfig(102039, "曹冲", 1, 10, 31, 85, 21, 137, 260, 2, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "inte", "FanExplosion", "caochong", 2);
            ...
            config[102041] = new HeroConfig(102041, "甄宓", 1, 18, 55, 74, 17, 146, 290, 2, 10, 17, 35, 0, 25, 0, 3, "鼓", null, "", "", "help", "SoulExplosionOrange", "zhenshi", 0);
            config[106003] = new HeroConfig(106003, "田丰", 1, 24, 72, 93, 33, 198, 250, 6, 10, 17, 15, 0, 32, 0, 3, "谋", null, "", "", "inte", "StormExplosion", "tianfeng", 1);
            config[103001] = new HeroConfig(103001, "孙坚", 1, 31, 93, 77, 90, 260, 290, 3, 10, 17, 0, 0, 95, 0, 1, "枪", null, "猛", "", "atk", "SwordHitYellowCritical", "sunjian", 3);
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, 31, 93, 76, 94, 263, 180, 3, 10, 17, 22, 1.5f, 100, 0, 3, "弓", null, "连", "劫", "shoot", "BulletExplosionBlue", "ganning", 2);
            ...
            config[103007] = new HeroConfig(103007, "鲁肃", 1, 28, 85, 92, 61, 238, 250, 3, 10, 17, 18, 0, 64, 0, 3, "相", null, "商", "", "help", "SharpExplosionGreen", "lusu", 2);
            ...
            config[103009] = new HeroConfig(103009, "蒋钦", 1, 25, 77, 57, 84, 218, 310, 3, 10, 17, 0, 0, 45, 0, 1, "戟", null, "", "", "atk", "SwordHitYellowCritical", "jiangqing", 2);
            config[103010] = new HeroConfig(103010, "吕蒙", 1, 30, 92, 91, 80, 263, 250, 3, 10, 17, 0, 0, 100, 0, 1, "马", null, "学", "劫", "def", "SwordHitYellowCritical", "lvmeng", 3);
            ...
            config[103016] = new HeroConfig(103016, "大乔", 1, 19, 57, 73, 14, 144, 280, 3, 10, 17, 15, 0, 25, 0, 3, "乐", null, "", "", "help", "StormExplosion", "daqiao", 2);
            config[103017] = new HeroConfig(103017, "小乔", 1, 13, 40, 74, 19, 133, 270, 3, 10, 17, 15, 0, 25, 0, 3, "乐", null, "", "", "help", "StormExplosion", "xiaoqiao", 2);
            ...
            config[103020] = new HeroConfig(103020, "凌统", 1, 25, 77, 62, 87, 226, 205, 3, 10, 17, 30, 1.5f, 52, 0, 3, "弩", null, "", "", "shoot", "BulletExplosionBlue", "lingtong", 1);
            ...
            config[103022] = new HeroConfig(103022, "朱治", 1, 24, 73, 59, 72, 204, 235, 3, 10, 17, 22, 1.5f, 35, 0, 3, "弓", null, "", "", "shoot", "BulletExplosionBlue", "zhuzhi", 1);
            ...
            config[103024] = new HeroConfig(103024, "程普", 1, 28, 84, 78, 80, 242, 300, 3, 10, 17, 0, 0, 69, 0, 1, "戟", null, "", "", "def", "SwordHitYellowCritical", "chengpu", 1);
            ...
            config[103027] = new HeroConfig(103027, "步骘", 1, 23, 70, 80, 65, 215, 315, 3, 10, 17, 35, 0, 43, 0, 3, "鼓", null, "", "", "help", "SoulExplosionOrange", "buzhi", 1);
            ...
            config[103030] = new HeroConfig(103030, "陆抗", 1, 30, 91, 87, 63, 241, 320, 3, 10, 17, 0, 0, 68, 0, 1, "枪", null, "透", "", "atk", "SwordHitYellowCritical", "lukang", 1);
            config[102022] = new HeroConfig(102022, "程昱", 1, 21, 63, 90, 54, 207, 240, 2, 10, 17, 15, 0, 37, 0, 3, "谋", null, "", "", "inte", "StormExplosion", "chengyu", 1);
            config[103032] = new HeroConfig(103032, "苏飞", 1, 23, 69, 66, 63, 198, 330, 3, 10, 17, 0, 0, 32, 0, 1, "刀", null, "米", "", "def", "SwordHitYellowCritical", "sufei", 0);
            config[103033] = new HeroConfig(103033, "全琮", 1, 26, 78, 75, 72, 225, 310, 3, 10, 17, 0, 0, 51, 0, 1, "戟", null, "", "", "def", "SwordHitYellowCritical", "quanzong", 0);
            ...
            config[103035] = new HeroConfig(103035, "朱然", 1, 26, 79, 71, 69, 219, 315, 3, 10, 17, 0, 0, 46, 0, 1, "枪", null, "", "", "def", "SwordHitYellowCritical", "zhuran", 2);
            config[103036] = new HeroConfig(103036, "孙韶", 1, 26, 80, 76, 79, 235, 310, 3, 10, 17, 0, 0, 61, 0, 1, "戟", null, "米", "", "def", "SwordHitYellowCritical", "sunshao", 1);
            config[103037] = new HeroConfig(103037, "孙桓", 1, 27, 82, 76, 73, 231, 315, 3, 10, 17, 0, 0, 57, 0, 1, "戟", null, "", "", "def", "SwordHitYellowCritical", "sunhuan", 1);
            config[103038] = new HeroConfig(103038, "严畯", 1, 20, 62, 82, 48, 192, 290, 3, 10, 17, 15, 0, 28, 0, 3, "扇", null, "", "", "inte", "FanExplosion", "yanjun", 1);
            config[104001] = new HeroConfig(104001, "吕布", 1, 32, 97, 43, 100, 240, 310, 4, 10, 17, 0, 0, 67, 0, 1, "车", null, "豪", "", "atk", "SwordHitBlackRedCritical", "lvbu", 5);
            ...
            config[102042] = new HeroConfig(102042, "戏志才", 1, 22, 66, 90, 24, 180, 270, 2, 10, 17, 15, 0, 25, 0, 3, "谋", null, "", "", "inte", "StormExplosion", "xizhicai", 0);
            config[104004] = new HeroConfig(104004, "貂蝉", 1, 9, 27, 81, 65, 173, 280, 4, 10, 17, 15, 0, 25, 0, 3, "乐", null, "", "", "help", "StormExplosion", "diaochan", 1);
            config[104005] = new HeroConfig(104005, "臧霸", 1, 26, 78, 53, 75, 206, 330, 4, 10, 17, 0, 0, 36, 0, 1, "马", null, "劫", "", "atk", "SwordHitYellowCritical", "zangba", 1);
            config[104006] = new HeroConfig(104006, "高顺", 1, 28, 85, 63, 86, 234, 215, 4, 10, 17, 13, 2.5f, 60, 0, 3, "炮", null, "劫", "", "shoot", "GasMissileFire", "gaoshun", 2);
            ...
            config[105001] = new HeroConfig(105001, "邓艾", 1, 31, 94, 89, 87, 270, 295, 5, 10, 17, 0, 0, 113, 0, 1, "枪", null, "解", "", "def", "SwordHitYellowCritical", "dengai", 2);
            ...
            config[105003] = new HeroConfig(105003, "司马昭", 1, 26, 78, 87, 57, 222, 290, 5, 10, 17, 18, 0, 48, 0, 3, "相", null, "", "", "help", "SharpExplosionGreen", "simazhao", 2);
            ...
            config[105008] = new HeroConfig(105008, "王濬", 1, 26, 80, 79, 52, 211, 340, 5, 10, 17, 0, 0, 40, 0, 1, "戟", null, "", "", "atk", "SwordHitYellowCritical", "wangrui", 2);
            config[105009] = new HeroConfig(105009, "辛宪英", 1, 14, 42, 84, 28, 154, 310, 5, 10, 17, 15, 0, 25, 0, 3, "扇", null, "", "", "inte", "FanExplosion", "xinxianying", 1);
            ...
            config[106008] = new HeroConfig(106008, "郭图", 1, 17, 52, 83, 50, 185, 290, 6, 10, 17, 15, 0, 25, 0, 3, "扇", null, "励", "", "help", "FanExplosion", "guotu", 1);
            config[110001] = new HeroConfig(110001, "公孙瓒", 1, 27, 83, 75, 82, 240, 295, 10, 10, 17, 0, 0, 67, 0, 1, "马", null, "", "", "def", "SwordHitYellowCritical", "gongsunzan", 2);
            config[110002] = new HeroConfig(110002, "张任", 1, 29, 88, 75, 84, 247, 210, 10, 10, 17, 22, 1.5f, 75, 0, 3, "弓", null, "", "", "shoot", "BulletExplosionBlue", "zhangren", 1);
            config[110003] = new HeroConfig(110003, "华佗", 1, 20, 60, 77, 34, 171, 330, 10, 10, 17, 14, 0, 25, 0, 3, "医", null, "", "", "help", "ShadowExplosionGreen", "huatuo", 2);
            ...
            config[110005] = new HeroConfig(110005, "马腾", 1, 27, 82, 51, 80, 213, 290, 10, 10, 17, 0, 0, 41, 0, 1, "马", null, "", "", "atk", "SwordHitYellowCritical", "mateng", 3);
            config[110006] = new HeroConfig(110006, "于吉", 1, 15, 47, 73, 41, 161, 310, 10, 10, 17, 14, 0, 25, 0, 3, "医", null, "", "", "help", "ShadowExplosionGreen", "yuji", 0);
            ...
            config[110009] = new HeroConfig(110009, "张梁", 1, 26, 78, 74, 80, 232, 310, 10, 10, 17, 0, 0, 58, 0, 1, "刀", null, "劫", "", "def", "SwordHitYellowCritical", "zhangliang", 1);
            config[110010] = new HeroConfig(110010, "韩遂", 1, 27, 81, 82, 75, 238, 290, 10, 10, 17, 0, 0, 64, 0, 1, "马", null, "米", "", "def", "SwordHitYellowCritical", "hansui", 1);
            ...
            config[110012] = new HeroConfig(110012, "蔡琰", 1, 20, 61, 77, 13, 151, 270, 10, 10, 17, 15, 0, 25, 0, 3, "乐", null, "", "", "help", "StormExplosion", "caiyan", 1);
