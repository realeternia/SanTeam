...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101004] = new HeroConfig(101004, "诸葛亮", 1, 32, 98, 100, 45, 243, 285, 1, 7, 35, 70, 0, "xiang", 3, null, "LightningExplosionBlue", "zhugeliang");
            config[101005] = new HeroConfig(101005, "关羽", 1, 32, 97, 77, 97, 271, 270, 1, 10, 17, 115, 0, "che", 1, null, "SwordHitYellowCritical", "guanyu");
            config[101006] = new HeroConfig(101006, "徐庶", 1, 29, 87, 93, 65, 245, 235, 1, 7, 35, 73, 0, "xiang", 3, null, "GasExplosionFire", "xusu");
            config[101007] = new HeroConfig(101007, "魏延", 1, 28, 84, 67, 91, 242, 300, 1, 10, 17, 69, 0, "che", 1, null, "SwordHitYellowCritical", "weiyan");
            config[101008] = new HeroConfig(101008, "黄忠", 1, 30, 90, 64, 93, 247, 235, 1, 6, 70, 75, 0, "", 3, new int[]{201005}, "BulletExplosionGreen", "huangzhong");
            ...
            config[101016] = new HeroConfig(101016, "孟获", 1, 29, 87, 51, 87, 225, 310, 1, 10, 17, 51, 0, "", 1, new int[]{201007}, "SwordHitYellowCritical", "menghuo");
            config[101017] = new HeroConfig(101017, "庞统", 1, 28, 85, 98, 42, 225, 260, 1, 7, 35, 51, 0, "xiang", 3, null, "ExplosionFireballFire", "pangtong");
            ...
            config[101021] = new HeroConfig(101021, "关索", 1, 24, 74, 69, 81, 224, 305, 1, 7, 50, 50, 0, "pao", 3, null, "BulletExplosionGreen", "guansuo");
            config[101022] = new HeroConfig(101022, "简雍", 1, 24, 72, 69, 65, 206, 240, 1, 7, 50, 36, 0, "pao", 3, null, "BulletExplosionGreen", "jianyong");
            ...
            config[101033] = new HeroConfig(101033, "法正", 1, 27, 83, 94, 52, 229, 255, 1, 7, 35, 55, 0, "xiang", 3, null, "GasExplosionFire", "fazheng");
            config[101034] = new HeroConfig(101034, "刘禅", 1, 13, 40, 50, 45, 135, 250, 1, 10, 17, 25, 0, "", 1, null, "SwordHitYellowCritical", "liushan");
            config[101035] = new HeroConfig(101035, "祝融", 1, 25, 77, 43, 85, 205, 290, 1, 10, 17, 36, 0, "", 1, new int[]{201007}, "SwordHitYellowCritical", "zhurong");
            config[101036] = new HeroConfig(101036, "黄权", 1, 25, 75, 82, 59, 216, 310, 1, 10, 17, 44, 0, "", 1, null, "SwordHitYellowCritical", "huangquan");
            config[101037] = new HeroConfig(101037, "孟达", 1, 25, 75, 68, 73, 216, 250, 1, 7, 50, 44, 0, "pao", 3, null, "BulletExplosionGreen", "mengda");
            config[101038] = new HeroConfig(101038, "刘封", 1, 25, 75, 44, 79, 198, 310, 1, 10, 17, 32, 0, "", 1, new int[]{201004}, "SwordHitYellowCritical", "liufeng");
            config[102001] = new HeroConfig(102001, "郭嘉", 1, 24, 72, 98, 43, 213, 260, 2, 7, 35, 41, 0, "xiang", 3, null, "FrostExplosionBlue", "guojia");
            config[102002] = new HeroConfig(102002, "夏侯惇", 1, 30, 90, 63, 90, 243, 300, 2, 10, 17, 70, 0, "che", 1, null, "SwordHitYellowCritical", "xiahoudun");
            config[102003] = new HeroConfig(102003, "荀彧", 1, 21, 65, 96, 43, 204, 270, 2, 7, 35, 35, 0, "xiang", 3, null, "FrostExplosionBlue", "xunyu");
            ...
            config[102006] = new HeroConfig(102006, "夏侯渊", 1, 30, 90, 68, 91, 249, 230, 2, 7, 50, 78, 0, "pao", 3, null, "BulletExplosionBlue", "xiahouyuan");
            config[102007] = new HeroConfig(102007, "典韦", 1, 19, 59, 43, 95, 197, 350, 2, 10, 17, 31, 0, "shi", 1, null, "SwordHitYellowCritical", "dianwei");
            config[102008] = new HeroConfig(102008, "张郃", 1, 29, 89, 75, 90, 254, 300, 2, 10, 17, 85, 0, "shi", 1, null, "SwordHitYellowCritical", "zhanghe");
            config[102009] = new HeroConfig(102009, "徐晃", 1, 30, 90, 77, 91, 258, 220, 2, 7, 50, 91, 0, "", 3, new int[]{201006}, "BulletExplosionBlue", "xuhuang");
            config[102010] = new HeroConfig(102010, "荀攸", 1, 20, 60, 92, 51, 203, 240, 2, 7, 35, 35, 0, "xiang", 3, null, "FrostExplosionBlue", "xunyou");
            ...
            config[102013] = new HeroConfig(102013, "曹洪", 1, 27, 82, 51, 83, 216, 260, 2, 10, 17, 44, 0, "", 1, new int[]{201003}, "SwordHitYellowCritical", "caohong");
            ...
            config[102016] = new HeroConfig(102016, "贾诩", 1, 28, 86, 97, 50, 233, 250, 2, 7, 35, 59, 0, "xiang", 3, null, "ShadowExplosion", "jiaxu");
            config[102017] = new HeroConfig(102017, "文聘", 1, 26, 80, 65, 82, 227, 270, 2, 10, 17, 53, 0, "", 1, null, "SwordHitYellowCritical", "wenpin");
            config[102018] = new HeroConfig(102018, "曹休", 1, 24, 73, 72, 73, 218, 250, 2, 7, 50, 45, 0, "pao", 3, null, "BulletExplosionBlue", "caoxiu");
            ...
            config[102030] = new HeroConfig(102030, "文鸯", 1, 25, 76, 64, 91, 231, 230, 2, 7, 50, 57, 0, "pao", 3, null, "BulletExplosionBlue", "wenyuan");
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, 31, 93, 76, 94, 263, 230, 3, 7, 50, 100, 0, "", 3, new int[]{201006}, "BulletExplosionFire", "ganning");
            ...
            config[103007] = new HeroConfig(103007, "鲁肃", 1, 28, 85, 92, 61, 238, 260, 3, 7, 35, 64, 0, "", 3, new int[]{201003}, "StormExplosion", "lusu");
            ...
            config[103011] = new HeroConfig(103011, "陆逊", 1, 32, 96, 94, 69, 259, 270, 3, 7, 35, 93, 0, "xiang", 3, null, "GasExplosionFire", "luxun");
            ...
            config[103016] = new HeroConfig(103016, "大乔", 1, 21, 65, 79, 70, 214, 280, 3, 10, 17, 42, 0, "", 1, new int[]{201002}, "SwordHitYellowCritical", "daqiao");
            config[103017] = new HeroConfig(103017, "小乔", 1, 20, 60, 85, 65, 210, 270, 3, 10, 17, 39, 0, "", 1, new int[]{201002}, "SwordHitYellowCritical", "xiaoqiao");
            ...
            config[103020] = new HeroConfig(103020, "凌统", 1, 25, 77, 62, 89, 228, 245, 3, 6, 70, 54, 0, "", 3, new int[]{201005}, "BulletExplosionFire", "lingtong");
            config[103021] = new HeroConfig(103021, "潘璋", 1, 25, 75, 74, 80, 229, 315, 3, 10, 17, 55, 0, "", 1, new int[]{201004}, "SwordHitYellowCritical", "panzhang");
            config[103022] = new HeroConfig(103022, "朱治", 1, 24, 73, 59, 72, 204, 235, 3, 7, 50, 35, 0, "pao", 3, null, "BulletExplosionFire", "zhuzhi");
            ...
            config[103033] = new HeroConfig(103033, "全琮", 1, 26, 78, 75, 72, 225, 300, 3, 10, 17, 51, 0, "", 1, null, "SwordHitYellowCritical", "quanzong");
            config[103034] = new HeroConfig(103034, "陈武", 1, 25, 76, 47, 87, 210, 305, 3, 12, 17, 39, 0, "shi", 1, null, "SwordHitYellowCritical", "chengwu");
            config[103035] = new HeroConfig(103035, "朱然", 1, 26, 79, 71, 69, 219, 315, 3, 10, 17, 46, 0, "", 1, null, "SwordHitYellowCritical", "zhuran");
            config[103036] = new HeroConfig(103036, "孙韶", 1, 26, 80, 76, 79, 235, 310, 3, 10, 17, 61, 0, "", 1, null, "SwordHitYellowCritical", "sunshao");
            config[103037] = new HeroConfig(103037, "孙桓", 1, 27, 82, 76, 73, 231, 300, 3, 10, 17, 57, 0, "", 1, null, "SwordHitYellowCritical", "sunhuan");
            config[103038] = new HeroConfig(103038, "严畯", 1, 20, 62, 82, 48, 192, 290, 3, 10, 17, 28, 0, "", 1, null, "SwordHitYellowCritical", "yanjun");
            config[103039] = new HeroConfig(103039, "于吉", 1, 15, 47, 73, 41, 161, 310, 3, 10, 17, 0, 45, "", 3, new int[]{201001}, "SwordHitYellowCritical", "yuji");
            config[104001] = new HeroConfig(104001, "董卓", 1, 28, 85, 75, 87, 247, 330, 4, 10, 17, 75, 0, "", 1, null, "SwordHitYellowCritical", "dongzhuo");
            config[104002] = new HeroConfig(104002, "吕布", 1, 32, 97, 41, 100, 238, 310, 4, 10, 17, 64, 0, "", 1, new int[]{200001}, "SwordHitYellowCritical", "lvbu");
            config[104003] = new HeroConfig(104003, "颜良", 1, 29, 88, 37, 93, 218, 315, 4, 10, 17, 45, 0, "shi", 1, null, "SwordHitYellowCritical", "yanliang");
            ...
            config[104007] = new HeroConfig(104007, "貂蝉", 1, 21, 65, 80, 65, 210, 280, 4, 10, 17, 39, 0, "", 1, new int[]{201002}, "SwordHitYellowCritical", "diaochan");
            config[104008] = new HeroConfig(104008, "张任", 1, 29, 88, 75, 84, 247, 255, 4, 7, 50, 75, 0, "pao", 3, null, "BulletExplosionFire", "zhangren");
            config[104009] = new HeroConfig(104009, "华佗", 1, 20, 60, 77, 34, 171, 330, 4, 10, 17, 0, 45, "", 3, new int[]{201001}, "SwordHitYellowCritical", "huatuo");
            ...
            config[104012] = new HeroConfig(104012, "李儒", 1, 20, 61, 91, 33, 185, 245, 4, 7, 35, 25, 0, "xiang", 3, null, "ShadowExplosion", "liru");
            config[104013] = new HeroConfig(104013, "袁绍", 1, 28, 86, 82, 73, 241, 310, 4, 10, 17, 68, 0, "", 1, null, "SwordHitYellowCritical", "yuanshao");
            config[104014] = new HeroConfig(104014, "袁术", 1, 22, 67, 65, 65, 197, 300, 4, 10, 17, 31, 0, "", 1, null, "SwordHitYellowCritical", "yuanshu");
            config[104015] = new HeroConfig(104015, "马腾", 1, 27, 82, 51, 80, 213, 275, 4, 12, 17, 41, 0, "ma", 1, null, "SwordHitYellowCritical", "mateng");
