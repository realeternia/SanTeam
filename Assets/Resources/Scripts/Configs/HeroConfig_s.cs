...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101008] = new HeroConfig(101008, "黄忠", 1, "弓", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 6, 0, 0, "强", "huangzhong");
            ...
            config[101012] = new HeroConfig(101012, "庞统", 1, "棋", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 8, 0, 0, "强", "pangtong");
            ...
            config[102005] = new HeroConfig(102005, "许褚", 1, "锤", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 8, 0, 0, "强", "xuchu");
            ...
            config[103007] = new HeroConfig(103007, "鲁肃", 1, "鼓", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "强", "lusu");
            config[103008] = new HeroConfig(103008, "周瑜", 1, "扇", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "强", "zhouyu");
            ...
            config[104001] = new HeroConfig(104001, "吕布", 1, "马", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 8, 0, 0, "强", "lvbu");
