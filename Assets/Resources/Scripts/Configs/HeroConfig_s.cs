...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        {
            config.Clear();
            config[101004] = new HeroConfig(101004, "诸葛亮", 1, 32, 98, 100, 45, 243, 255, 1, 7, 35, 0, 30, "xiang", null, "ExplosionFireballFire", "zhugeliang");
            config[102019] = new HeroConfig(102019, "司马懿", 1, 32, 98, 98, 63, 259, 250, 2, 7, 35, 59, 0, "xiang", null, "ShadowExplosion", "simayi");
            config[102001] = new HeroConfig(102001, "郭嘉", 1, 24, 72, 98, 43, 213, 260, 2, 7, 35, 28, 0, "xiang", null, "FrostExplosionBlue", "guojia");
            config[101017] = new HeroConfig(101017, "庞统", 1, 28, 85, 98, 42, 225, 240, 1, 7, 35, 34, 0, "xiang", null, "ShadowExplosion", "pangtong");
            config[102016] = new HeroConfig(102016, "贾诩", 1, 28, 86, 97, 50, 233, 250, 2, 7, 35, 39, 0, "xiang", null, "StormExplosion", "jiaxu");
            config[102003] = new HeroConfig(102003, "荀彧", 1, 21, 65, 96, 43, 204, 270, 2, 7, 35, 24, 0, "xiang", null, "StormExplosion", "xunyu");
            config[103008] = new HeroConfig(103008, "周瑜", 1, 32, 96, 96, 71, 263, 250, 3, 7, 35, 63, 0, "xiang", null, "ExplosionFireballFire", "zhouyu");
            config[103011] = new HeroConfig(103011, "陆逊", 1, 32, 96, 94, 69, 259, 270, 3, 7, 35, 59, 0, "xiang", null, "StormExplosion", "luxun");
            config[101033] = new HeroConfig(101033, "法正", 1, 27, 83, 94, 52, 229, 255, 1, 7, 35, 37, 0, "xiang", null, "SwordHitYellowCritical", "fazheng");
            config[101031] = new HeroConfig(101031, "马良", 1, 21, 65, 93, 60, 218, 250, 1, 7, 35, 31, 0, "xiang", null, "StormExplosion", "maliang");
            config[101006] = new HeroConfig(101006, "徐庶", 1, 29, 87, 93, 65, 245, 235, 1, 7, 35, 47, 0, "xiang", null, "StormExplosion", "xusu");
            config[100002] = new HeroConfig(100002, "曹操", 1, 32, 98, 92, 81, 271, 265, 2, 10, 17, 0, 100, "shuai", null, "SwordHitYellowCritical", "caocao");
            config[103007] = new HeroConfig(103007, "鲁肃", 1, 28, 85, 92, 61, 238, 260, 3, 7, 35, 42, 0, "xiang", null, "StormExplosion", "lusu");
            config[102028] = new HeroConfig(102028, "钟会", 1, 27, 82, 92, 55, 229, 260, 2, 7, 35, 37, 0, "xiang", null, "StormExplosion", "zhonghui");
            config[102010] = new HeroConfig(102010, "荀攸", 1, 20, 60, 92, 51, 203, 240, 2, 7, 35, 24, 0, "xiang", null, "StormExplosion", "xunyou");
            ...
            config[102026] = new HeroConfig(102026, "程昱", 1, 21, 63, 90, 54, 207, 240, 2, 7, 35, 26, 0, "xiang", null, "StormExplosion", "chengyu");
            ...
            config[103012] = new HeroConfig(103012, "张昭", 1, 21, 65, 89, 41, 195, 245, 3, 7, 35, 21, 0, "xiang", null, "StormExplosion", "zhangzhao");
            config[101026] = new HeroConfig(101026, "马谡", 1, 23, 70, 88, 72, 230, 270, 1, 7, 35, 37, 0, "xiang", null, "StormExplosion", "masu");
            config[102027] = new HeroConfig(102027, "杨修", 1, 20, 60, 88, 57, 205, 260, 2, 7, 35, 25, 0, "xiang", null, "StormExplosion", "yangxiu");
            config[102036] = new HeroConfig(102036, "刘晔", 1, 21, 65, 88, 49, 202, 250, 2, 7, 35, 24, 0, "xiang", null, "StormExplosion", "liuye");
            ...
            config[102039] = new HeroConfig(102039, "陈泰", 1, 28, 84, 86, 77, 247, 300, 2, 10, 17, 49, 0, "", null, "SwordHitYellowCritical", "chentai");
            config[101025] = new HeroConfig(101025, "费祎", 1, 22, 68, 86, 42, 196, 250, 1, 7, 35, 21, 0, "xiang", null, "StormExplosion", "feiyi");
            ...
            config[103039] = new HeroConfig(103039, "张纮", 1, 22, 68, 85, 50, 203, 250, 3, 7, 35, 24, 0, "xiang", null, "StormExplosion", "zhanghong");
            config[101023] = new HeroConfig(101023, "蒋琬", 1, 21, 64, 85, 52, 201, 240, 1, 7, 35, 23, 0, "xiang", null, "StormExplosion", "jiangwan");
            config[102038] = new HeroConfig(102038, "羊枯", 1, 30, 90, 84, 64, 238, 320, 2, 10, 17, 42, 0, "", null, "SwordHitYellowCritical", "yangku");
            ...
            config[102009] = new HeroConfig(102009, "徐晃", 1, 30, 90, 77, 91, 258, 220, 2, 7, 50, 58, 0, "pao", null, "BulletExplosionFire", "xuhuang");
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, 31, 93, 76, 94, 263, 230, 3, 7, 50, 63, 0, "pao", null, "BulletExplosionFire", "ganning");
            ...
            config[103002] = new HeroConfig(103002, "孙策", 1, 32, 96, 74, 93, 263, 285, 3, 10, 17, 63, 0, "che", null, "SwordHitYellowCritical", "sunce");
            ...
            config[101008] = new HeroConfig(101008, "黄忠", 1, 30, 90, 64, 93, 247, 215, 1, 7, 50, 49, 0, "pao", null, "BulletExplosionFire", "huangzhong");
            ...
            config[101038] = new HeroConfig(101038, "刘封", 1, 25, 75, 44, 79, 198, 320, 1, 10, 17, 22, 0, "", null, "SwordHitYellowCritical", "liufeng");
            config[102040] = new HeroConfig(102040, "曹彰", 1, 27, 82, 43, 90, 215, 350, 2, 10, 17, 29, 0, "", null, "SwordHitYellowCritical", "caozhang");
            ...
            config[104002] = new HeroConfig(104002, "吕布", 1, 32, 97, 41, 100, 238, 325, 4, 12, 17, 0, 30, "ma", null, "SwordHitYellowCritical", "lvbu");
