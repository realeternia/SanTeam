...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101012] = new HeroConfig(101012, "庞统", 1, "琴", 4, 13, 80, 6, 80, 1, 80, 615, 80, 0, 0, 0, 1, 7, 0, 0, 15, 0f, 3, "锁", "火", "inte", "ExplosionFireballFire", "pangtong");
            ...
            config[101015] = new HeroConfig(101015, "蒋琬", 1, "医", 1, -12, 80, -16, 80, -2, 80, 422, 80, 0, -20, -20, 1, 2, 0, 0, 18, 0f, 3, "", "", "help", "SharpExplosionGreen", "jiangwan");
            ...
            config[101018] = new HeroConfig(101018, "马谡", 1, "医", 2, -6, 80, -10, 80, 21, 80, 558, 80, 0, 0, 0, 1, 6, 0, 0, 15, 0f, 3, "百", "", "inte", "StormExplosion", "masu");
            config[101019] = new HeroConfig(101019, "马良", 1, "相", 2, 0, 80, 3, 80, 12, 80, 573, 80, 0, 0, 0, 1, 6, 0, 0, 18, 0f, 3, "静", "", "help", "SharpExplosionGreen", "maliang");
            config[101020] = new HeroConfig(101020, "法正", 1, "扇", 3, 6, 80, -4, 80, 3, 80, 575, 80, 0, 0, 0, 1, 7, 0, 0, 15, 0f, 3, "溃", "", "inte", "GasExplosionFire", "fazheng");
            ...
            config[102005] = new HeroConfig(102005, "许褚", 1, "士", 4, 1, 80, -7, 80, 21, 80, 794, 80, 0, 0, 0, 2, 7, 0, 0, 0, 0f, 1, "斧", "", "atk", "SwordHitYellowCritical", "xuchu");
            ...
            config[102007] = new HeroConfig(102007, "典韦", 1, "士", 4, -3, 80, -6, 80, 24, 80, 807, 80, 0, 0, 0, 2, 7, 0, 0, 0, 0f, 1, "护", "", "def", "SwordHitYellowCritical", "dianwei");
            ...
            config[102010] = new HeroConfig(102010, "荀攸", 1, "医", 3, -2, 80, 10, 80, 12, 80, 623, 80, 0, 0, 0, 2, 7, 0, 0, 15, 0f, 3, "百", "米", "inte", "FrostExplosionBlue", "xunyou");
            ...
            config[102015] = new HeroConfig(102015, "乐进", 1, "相", 1, -4, 80, -6, 80, 0, 80, 620, 80, 0, -10, -10, 2, 2, 0, 0, 0, 0f, 1, "奋", "", "atk", "SwordHitYellowCritical", "lejin");
            config[102016] = new HeroConfig(102016, "司马懿", 1, "棋", 4, 15, 80, -5, 80, 10, 80, 603, 80, 0, 0, 0, 2, 7, 0, 0, 15, 0f, 3, "鬼", "", "inte", "ShadowExplosion", "simayi");
            config[102017] = new HeroConfig(102017, "程昱", 1, "医", 2, -6, 80, 1, 80, 10, 80, 561, 80, 0, 0, 0, 2, 4, 0, 0, 15, 0f, 3, "识", "火", "inte", "StormExplosion", "chengyu");
            config[102018] = new HeroConfig(102018, "文鸯", 1, "弓", 1, -6, 80, -1, 80, 7, 80, 510, 80, 0, 0, 0, 2, 4, 0, 0, 22, 1.5f, 3, "速", "", "shoot", "BulletExplosionBlue", "wenyuan");
            ...
            config[102020] = new HeroConfig(102020, "陈群", 1, "琴", 1, 5, 80, 5, 80, 0, 80, 522, 80, 0, 0, 0, 2, 2, 0, 0, 15, 0f, 3, "励", "米", "help", "FanExplosion", "chenqun");
            config[102021] = new HeroConfig(102021, "李典", 1, "弩", 2, -3, 80, 18, 80, -5, 80, 750, 80, 0, -10, -10, 2, 4, 0, 0, 0, 0f, 1, "伏", "坚", "def", "SwordHitYellowCritical", "lidian");
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, "弓", 4, -1, 80, 1, 80, 0, 80, 484, 80, 0, 0, 0, 3, 7, 0, 0, 22, 1.5f, 3, "连", "", "shoot", "BulletExplosionBlue", "ganning");
            ...
            config[103011] = new HeroConfig(103011, "陆逊", 1, "棋", 4, 13, 80, -8, 80, 15, 80, 603, 80, 0, 0, 0, 3, 7, 0, 0, 15, 0f, 3, "炎", "", "inte", "GasExplosionFire", "luxun");
            ...
            config[103013] = new HeroConfig(103013, "诸葛瑾", 1, "扇", 3, 12, 80, 1, 80, -3, 80, 531, 80, 0, 0, 0, 3, 4, 0, 0, 15, 0f, 3, "励", "", "help", "FanExplosion", "zhugejin");
            ...
            config[103019] = new HeroConfig(103019, "凌统", 1, "弩", 1, 1, 80, -1, 80, 0, 80, 457, 80, 0, 0, 0, 3, 4, 0, 0, 30, 1.5f, 3, "虐", "", "shoot", "BulletExplosionBlue", "lingtong");
            ...
            config[104002] = new HeroConfig(104002, "华雄", 1, "锤", 3, -7, 80, 7, 80, -5, 80, 754, 80, 0, -10, -10, 4, 6, 0, 0, 0, 0f, 1, "纷", "", "atk", "SwordHitYellowCritical", "huaxiong");
            config[104003] = new HeroConfig(104003, "贾诩", 1, "扇", 3, 13, 80, 4, 80, 3, 80, 620, 80, 0, 0, 0, 4, 7, 0, 0, 15, 0f, 3, "延", "", "inte", "StormExplosion", "jiaxu");
            config[104004] = new HeroConfig(104004, "貂蝉", 1, "医", 3, -19, 80, -8, 80, 22, 80, 439, 80, 0, 0, 0, 4, 5, 0, 0, 15, 0f, 3, "曲", "", "help", "StormExplosion", "diaochan");
            ...
            config[104007] = new HeroConfig(104007, "李儒", 1, "鼓", 3, -12, 80, -7, 80, -6, 80, 476, 80, 0, -10, -10, 4, 4, 0, 0, 15, 0f, 3, "火", "", "inte", "ShadowExplosion", "liru");
            config[104008] = new HeroConfig(104008, "陈宫", 1, "琴", 3, 7, 80, -8, 80, 6, 80, 569, 80, 0, 0, 0, 4, 7, 0, 0, 15, 0f, 3, "励", "溃", "inte", "ShadowExplosion", "chengong");
            ...
            config[105003] = new HeroConfig(105003, "司马昭", 1, "医", 3, 9, 80, -3, 80, 9, 80, 582, 80, 0, 0, 0, 5, 5, 0, 0, 18, 0f, 3, "溃", "", "help", "SharpExplosionGreen", "simazhao");
            config[105004] = new HeroConfig(105004, "羊祜", 1, "戟", 2, 10, 80, 24, 80, -14, 80, 760, 80, 0, 0, 0, 5, 6, 0, 0, 0, 0f, 1, "敏", "", "atk", "SwordHitYellowCritical", "yangku");
            ...
            config[106005] = new HeroConfig(106005, "许攸", 1, "炮", 2, -27, 80, 0, 80, -13, 80, 442, 80, 0, -20, -20, 6, 5, 0, 0, 15, 0f, 3, "火", "", "inte", "StormExplosion", "xuyou");
            ...
            config[106007] = new HeroConfig(106007, "沮授", 1, "琴", 2, 5, 80, -4, 80, -11, 80, 518, 80, 0, -10, -10, 6, 4, 0, 0, 15, 0f, 3, "静", "", "inte", "StormExplosion", "jushou");
            ...
            config[110006] = new HeroConfig(110006, "于吉", 1, "鼓", 2, -2, 80, -4, 80, 1, 80, 501, 80, 0, 0, 0, 10, 4, 0, 0, 14, 0f, 3, "调", "", "help", "ShadowExplosionGreen", "yuji");
            ...
            config[110009] = new HeroConfig(110009, "张梁", 1, "扇", 1, 1, 80, -3, 80, 2, 80, 465, 80, 0, 0, 0, 10, 2, 0, 0, 13, 2.5f, 3, "", "", "def", "SwordHitYellowCritical", "zhangliang");
