...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[101003] = new HeroConfig(101003, "马超", 1, "马", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 8, 0, 0, "马超", "machao");
            config[101004] = new HeroConfig(101004, "诸葛亮", 1, "工", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 8, 0, 0, "诸葛亮", "zhugeliang");
            config[101005] = new HeroConfig(101005, "关羽", 1, "车", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 8, 0, 0, "关羽", "guanyu");
            config[101006] = new HeroConfig(101006, "徐庶", 1, "炮", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 6, 0, 0, "徐庶", "xusu");
            ...
            config[101009] = new HeroConfig(101009, "周仓", 1, "盾", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 2, 0, 0, "周仓", "zhoucang");
            config[101010] = new HeroConfig(101010, "姜维", 1, "车", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 8, 0, 0, "姜维", "jiangwei");
            config[101011] = new HeroConfig(101011, "马岱", 1, "弩", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 4, 0, 0, "马岱", "madai");
            ...
            config[101015] = new HeroConfig(101015, "蒋琬", 1, "相", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 2, 0, 0, "蒋琬", "jiangwan");
            config[101016] = new HeroConfig(101016, "孙乾", 1, "鼓", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 2, 0, 0, "孙乾", "sunqian");
            config[101017] = new HeroConfig(101017, "费祎", 1, "鼓", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 4, 0, 0, "费祎", "feiyi");
            config[101018] = new HeroConfig(101018, "马谡", 1, "枪", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 2, 0, 0, "强", "masu");
            config[101019] = new HeroConfig(101019, "马良", 1, "相", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 4, 0, 0, "马良", "maliang");
            config[101020] = new HeroConfig(101020, "法正", 1, "棋", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 6, 0, 0, "强", "fazheng");
            config[101021] = new HeroConfig(101021, "刘禅", 1, "医", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 2, 0, 0, "刘禅", "liushan");
            config[101022] = new HeroConfig(101022, "严颜", 1, "盾", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 1, 4, 0, 0, "严颜", "yanyan");
            ...
            config[102002] = new HeroConfig(102002, "夏侯惇", 1, "车", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 6, 0, 0, "夏侯惇", "xiahoudun");
            config[102003] = new HeroConfig(102003, "荀彧", 1, "相", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 8, 0, 0, "荀彧", "xunyu");
            ...
            config[102006] = new HeroConfig(102006, "夏侯渊", 1, "弓", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 6, 0, 0, "夏侯渊", "xiahouyuan");
            config[102007] = new HeroConfig(102007, "典韦", 1, "戟", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 8, 0, 0, "强", "dianwei");
            config[102008] = new HeroConfig(102008, "张郃", 1, "炮", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 8, 0, 0, "张郃", "zhanghe");
            ...
            config[102012] = new HeroConfig(102012, "曹仁", 1, "盾", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 6, 0, 0, "曹仁", "caoren");
            ...
            config[102015] = new HeroConfig(102015, "乐进", 1, "车", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 2, 0, 0, "乐进", "lejin");
            ...
            config[102018] = new HeroConfig(102018, "文鸯", 1, "弩", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 2, 0, 0, "文鸯", "wenyuan");
            ...
            config[102023] = new HeroConfig(102023, "曹彰", 1, "马", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 6, 0, 0, "曹彰", "caozhang");
            config[102024] = new HeroConfig(102024, "蔡文姬", 1, "琴", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 4, 0, 0, "蔡文姬", "caiyan");
            config[102025] = new HeroConfig(102025, "甄宓", 1, "琴", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 2, 2, 0, 0, "甄宓", "zhenshi");
            ...
            config[103003] = new HeroConfig(103003, "甘宁", 1, "弩", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "甘宁", "ganning");
            config[103004] = new HeroConfig(103004, "太史慈", 1, "弓", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "太史慈", "taishici");
            ...
            config[103010] = new HeroConfig(103010, "吕蒙", 1, "盾", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "吕蒙", "lvmeng");
            config[103011] = new HeroConfig(103011, "陆逊", 1, "炮", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 8, 0, 0, "陆逊", "luxun");
            config[103012] = new HeroConfig(103012, "张昭", 1, "相", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 6, 0, 0, "张昭", "zhangzhao");
            config[103013] = new HeroConfig(103013, "诸葛瑾", 1, "鼓", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 6, 0, 0, "诸葛瑾", "zhugejin");
            config[103014] = new HeroConfig(103014, "孙尚香", 1, "弩", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 6, 0, 0, "孙尚香", "sunshangxiang");
            config[103015] = new HeroConfig(103015, "朱桓", 1, "马", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 4, 0, 0, "朱桓", "zhuhuan");
            config[103016] = new HeroConfig(103016, "大乔", 1, "琴", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 6, 0, 0, "大乔", "daqiao");
            config[103017] = new HeroConfig(103017, "小乔", 1, "琴", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 4, 0, 0, "小乔", "xiaoqiao");
            config[103018] = new HeroConfig(103018, "丁奉", 1, "炮", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 2, 0, 0, "丁奉", "dingfeng");
            config[103019] = new HeroConfig(103019, "凌统", 1, "弓", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 2, 0, 0, "凌统", "lingtong");
            config[103020] = new HeroConfig(103020, "潘璋", 1, "锤", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 2, 0, 0, "强", "panzhang");
            config[103021] = new HeroConfig(103021, "徐盛", 1, "盾", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 2, 0, 0, "徐盛", "xusheng");
            config[103022] = new HeroConfig(103022, "程普", 1, "车", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 4, 0, 0, "程普", "chengpu");
            config[103023] = new HeroConfig(103023, "韩当", 1, "马", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 3, 4, 0, 0, "韩当", "handang");
            config[104001] = new HeroConfig(104001, "吕布", 1, "马", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 8, 0, 0, "吕布", "lvbu");
            config[104002] = new HeroConfig(104002, "华雄", 1, "马", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 6, 0, 0, "华雄", "huaxiong");
            config[104003] = new HeroConfig(104003, "贾诩", 1, "相", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 6, 0, 0, "贾诩", "jiaxu");
            config[104004] = new HeroConfig(104004, "貂蝉", 1, "琴", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 6, 0, 0, "貂蝉", "diaochan");
            config[104006] = new HeroConfig(104006, "高顺", 1, "炮", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 4, 4, 0, 0, "高顺", "gaoshun");
            ...
            config[105001] = new HeroConfig(105001, "邓艾", 1, "盾", 4, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 8, 0, 0, "邓艾", "dengai");
            config[105002] = new HeroConfig(105002, "司马师", 1, "鼓", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 4, 0, 0, "司马师", "simashi");
            ...
            config[105006] = new HeroConfig(105006, "陈泰", 1, "马", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 2, 0, 0, "陈泰", "chentai");
            config[105007] = new HeroConfig(105007, "杜预", 1, "工", 1, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 2, 0, 0, "强", "duyu");
            config[105008] = new HeroConfig(105008, "王濬", 1, "炮", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 4, 0, 0, "王濬", "wangrui");
            config[105009] = new HeroConfig(105009, "王双", 1, "锤", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 5, 4, 0, 0, "强", "wangshuang");
            config[106001] = new HeroConfig(106001, "颜良", 1, "车", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 6, 6, 0, 0, "颜良", "yanliang");
            config[106002] = new HeroConfig(106002, "文丑", 1, "戟", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 6, 6, 0, 0, "强", "wenchou");
            config[106003] = new HeroConfig(106003, "田丰", 1, "鼓", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 6, 6, 0, 0, "田丰", "tianfeng");
            config[106004] = new HeroConfig(106004, "鞠义", 1, "弩", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 6, 4, 0, 0, "鞠义", "juyi");
            ...
            config[110006] = new HeroConfig(110006, "于吉", 1, "医", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 10, 4, 0, 0, "于吉", "yuji");
            config[110007] = new HeroConfig(110007, "张角", 1, "工", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 10, 6, 0, 0, "张角", "zhangjiao");
            config[110008] = new HeroConfig(110008, "张宝", 1, "医", 2, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 10, 4, 0, 0, "张宝", "zhangbao2");
            ...
            config[110011] = new HeroConfig(110011, "左慈", 1, "医", 3, 0, 0, 0, 100, 100, 0, 0, 0, 0, 0, 10, 6, 0, 0, "左慈", "zuoci");
