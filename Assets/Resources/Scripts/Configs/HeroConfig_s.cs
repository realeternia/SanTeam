...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[100005] = new HeroConfig(100005, "司马炎", 1, "帅", 2, -3, 80, 5, 80, -10, 80, 732, 80, 0, 0, 0, 5, 7, 0, 0, 0, 0f, 1, "", "", "core", "SwordHitYellowCritical", "simayan");
            config[100006] = new HeroConfig(100006, "袁绍", 1, "帅", 2, 0, 80, -4, 80, -6, 80, 695, 80, 0, 0, 0, 6, 7, 0, 0, 0, 0f, 1, "", "", "core", "SwordHitYellowCritical", "yuanshao");
            ...
            config[101004] = new HeroConfig(101004, "诸葛亮", 1, "工", 4, 27, 80, 9, 80, -1, 80, 690, 80, 0, 10, 10, 1, 9, 0, 0, 18, 0f, 3, "神", "空", "inte", "LightningExplosionYellow", "zhugeliang");
            ...
            config[101017] = new HeroConfig(101017, "费祎", 1, "鼓", 2, -3, 80, -6, 80, -6, 80, 476, 80, 0, -10, -10, 1, 4, 0, 0, 18, 0f, 3, "励", "", "help", "SharpExplosionGreen", "feiyi");
            config[101018] = new HeroConfig(101018, "马谡", 1, "枪", 1, -6, 80, -10, 80, 21, 80, 558, 80, 0, 0, 0, 1, 6, 0, 0, 15, 0f, 3, "百", "", "inte", "StormExplosion", "masu");
            ...
            config[101022] = new HeroConfig(101022, "严颜", 1, "盾", 2, 2, 80, 6, 80, -3, 80, 728, 80, 0, -10, -10, 1, 4, 0, 0, 0, 0f, 1, "", "", "def", "SwordHitYellowCritical", "yanyan");
            config[101023] = new HeroConfig(101023, "黄月英", 1, "工", 2, -3, 80, 10, 80, -2, 80, 520, 80, 0, -10, -10, 1, 4, 0, 0, 18, 0f, 3, "", "", "inte", "StormExplosion", "huangyueying");
            ...
            config[102014] = new HeroConfig(102014, "庞德", 1, "士", 3, 3, 80, 14, 80, 8, 80, 830, 80, 0, 0, 0, 2, 7, 0, 0, 0, 0f, 1, "坚", "", "atk", "SwordHitYellowCritical", "pangde");
            ...
            config[102020] = new HeroConfig(102020, "陈群", 1, "工", 1, 5, 80, 5, 80, 0, 80, 522, 80, 0, 0, 0, 2, 2, 0, 0, 15, 0f, 3, "励", "米", "help", "FanExplosion", "chenqun");
            ...
            config[102022] = new HeroConfig(102022, "刘晔", 1, "工", 2, -7, 80, 12, 80, -20, 80, 405, 80, 0, -10, -10, 2, 2, 0, 0, 13, 2.5f, 3, "", "", "shoot", "GasShootFire", "liuye");
            config[102023] = new HeroConfig(102023, "曹彰", 1, "马", 3, 5, 80, -4, 80, 9, 80, 800, 80, 0, 0, 0, 2, 7, 0, 0, 0, 0f, 1, "", "", "atk", "SwordHitYellowCritical", "caozhang");
            config[102024] = new HeroConfig(102024, "蔡文姬", 1, "琴", 2, -2, 80, 9, 80, -12, 80, 445, 80, 0, -10, -10, 2, 4, 0, 0, 15, 0f, 3, "", "", "help", "StormExplosion", "caiwenji");
            config[102025] = new HeroConfig(102025, "甄宓", 1, "琴", 1, -6, 80, 4, 80, -8, 80, 415, 80, 0, -10, -10, 2, 2, 0, 0, 15, 0f, 3, "", "", "help", "StormExplosion", "zhenmi");
            ...
            config[103007] = new HeroConfig(103007, "鲁肃", 1, "鼓", 4, 15, 80, 2, 80, 13, 80, 615, 80, 0, 0, 0, 3, 9, 0, 0, 18, 0f, 3, "商", "雷", "help", "SharpExplosionGreen", "lusu");
            config[103008] = new HeroConfig(103008, "周瑜", 1, "扇", 4, 17, 80, -2, 80, 20, 80, 675, 80, 0, 10, 10, 3, 9, 0, 0, 15, 0f, 3, "炎", "炽", "inte", "ExplosionFireballFire", "zhouyu");
            ...
            config[103010] = new HeroConfig(103010, "吕蒙", 1, "盾", 4, 4, 80, 28, 80, -7, 80, 815, 80, 0, 0, 0, 3, 9, 0, 0, 0, 0f, 1, "学", "羽", "def", "SwordHitYellowCritical", "lvmeng");
            ...
            config[103015] = new HeroConfig(103015, "朱桓", 1, "马", 2, 3, 80, 21, 80, 1, 80, 850, 80, 0, 0, 0, 3, 4, 0, 0, 0, 0f, 1, "伏", "缓", "def", "SwordHitYellowCritical", "zhuhuan");
            ...
            config[103022] = new HeroConfig(103022, "程普", 1, "车", 2, 3, 80, 18, 80, -1, 80, 750, 80, 0, 0, 0, 3, 4, 0, 0, 0, 0f, 1, "实", "奋", "def", "SwordHitYellowCritical", "chengpu");
            config[103023] = new HeroConfig(103023, "韩当", 1, "马", 2, 2, 80, 5, 80, -4, 80, 738, 80, 0, -10, -10, 3, 4, 0, 0, 0, 0f, 1, "", "", "def", "SwordHitYellowCritical", "handang");
            ...
            config[104002] = new HeroConfig(104002, "华雄", 1, "马", 3, -7, 80, 7, 80, -5, 80, 754, 80, 0, -10, -10, 4, 6, 0, 0, 0, 0f, 1, "纷", "", "atk", "SwordHitYellowCritical", "huaxiong");
            config[104003] = new HeroConfig(104003, "贾诩", 1, "相", 3, 13, 80, 4, 80, 3, 80, 620, 80, 0, 0, 0, 4, 7, 0, 0, 15, 0f, 3, "延", "", "inte", "StormExplosion", "jiaxu");
            ...
            config[104009] = new HeroConfig(104009, "张绣", 1, "枪", 3, 4, 80, 7, 80, 4, 80, 790, 80, 0, 0, 0, 4, 7, 0, 0, 0, 0f, 1, "", "", "atk", "SwordHitYellowCritical", "zhangxiu");
            ...
            config[105003] = new HeroConfig(105003, "司马昭", 1, "扇", 3, 9, 80, -3, 80, 9, 80, 582, 80, 0, 0, 0, 5, 5, 0, 0, 18, 0f, 3, "溃", "", "help", "SharpExplosionGreen", "simazhao");
            ...
            config[105007] = new HeroConfig(105007, "杜预", 1, "工", 1, 17, 80, -1, 80, -16, 80, 544, 80, 0, -10, -10, 5, 2, 0, 0, 18, 0f, 3, "米", "", "inte", "SharpExplosionGreen", "duyu");
            config[105008] = new HeroConfig(105008, "王濬", 1, "炮", 2, -4, 80, 9, 80, -8, 80, 520, 80, 0, -10, -10, 5, 4, 0, 0, 13, 2.5f, 3, "", "", "shoot", "GasShootFire", "wangjun");
            config[105009] = new HeroConfig(105009, "王双", 1, "锤", 2, 3, 80, -5, 80, 6, 80, 735, 80, 0, -10, -10, 5, 4, 0, 0, 0, 0f, 1, "", "", "atk", "SwordHitYellowCritical", "wangshuang");
            ...
            config[106002] = new HeroConfig(106002, "文丑", 1, "戟", 3, -3, 80, -3, 80, 1, 80, 777, 80, 0, -10, -10, 6, 7, 0, 0, 0, 0f, 1, "刺", "", "def", "SwordHitYellowCritical", "wenchou");
            ...
            config[106005] = new HeroConfig(106005, "许攸", 1, "扇", 2, -27, 80, 0, 80, -13, 80, 442, 80, 0, -20, -20, 6, 5, 0, 0, 15, 0f, 3, "火", "", "inte", "StormExplosion", "xuyou");
            ...
            config[110007] = new HeroConfig(110007, "张角", 1, "工", 3, 27, 80, 6, 80, -13, 80, 629, 80, 0, 0, 0, 10, 7, 0, 0, 15, 0f, 3, "天", "陷", "inte", "LightningExplosionBlue", "zhangjiao");
            config[110008] = new HeroConfig(110008, "张宝", 1, "医", 2, -5, 80, 17, 80, -17, 80, 680, 80, 0, -10, -10, 10, 4, 0, 0, 0, 0f, 1, "劫", "", "atk", "SwordHitYellowCritical", "zhangbao2");
            ...
            config[110010] = new HeroConfig(110010, "孟获", 1, "锤", 3, 2, 80, -6, 80, 12, 80, 810, 80, 0, 0, 0, 10, 7, 0, 0, 0, 0f, 1, "", "", "atk", "SwordHitYellowCritical", "menghuo");
            config[110011] = new HeroConfig(110011, "左慈", 1, "医", 3, -4, 80, 14, 80, 4, 80, 560, 80, 0, 0, 0, 10, 7, 0, 0, 14, 0f, 3, "", "", "help", "ShadowExplosionGreen", "zuoci");
