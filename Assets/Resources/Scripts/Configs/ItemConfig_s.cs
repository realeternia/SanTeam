...
namespace CommonConfig
{
    public class ItemConfig
    {
        ...
        public ItemConfig(int Id, string Name, string Des, int Quality, string Effect, string Attrs, int[] Skills, string LimitSkillSname, bool RemoveWhenUse, int CombineId, int CombineNeed, string Icon)
        {
            this.Id = Id;
            this.Name = Name;
            this.Des = Des;
        ...
        {
            config.Clear();
            config[400001] = new ItemConfig(400001, "关王刀", "攻击+30，护甲+30", 2, "attr", "atk+30,armor+30", new int[0], "", false, 0, 0, "guanwangdao");
            config[400002] = new ItemConfig(400002, "方天画戟", "攻击+30，暴击+22%", 2, "attr", "atk+30,crit+0.22", new int[0], "", false, 0, 0, "fangtian");
            ...
            config[401015] = new ItemConfig(401015, "文赋·精", "法术强度+5，魔法抗性+5", 2, "tpattr", "ap+5,magicres+5", new int[0], "", true, 0, 0, "wenfu2");
            config[402001] = new ItemConfig(402001, "长刀", "攻击+10", 1, "attr", "atk+10", new int[0], "", false, 0, 0, "jian1");
            config[402002] = new ItemConfig(402002, "皮革甲", "护甲+20", 1, "attr", "armor+20", new int[0], "", false, 0, 0, "jia1");
            config[402003] = new ItemConfig(402003, "檀木弓", "攻速+10%", 1, "attr", "atkspeed+0.1", new int[0], "", false, 0, 0, "tanmugong");
            config[402004] = new ItemConfig(402004, "斗篷", "魔抗+20", 1, "attr", "magicres+20", new int[0], "", false, 0, 0, "doupeng");
            config[402005] = new ItemConfig(402005, "葫芦", "每秒回复1点法力", 1, "attr", "mpRegen+1", new int[0], "", false, 0, 0, "hulu");
            config[402006] = new ItemConfig(402006, "护手", "暴击+15%", 1, "attr", "crit+0.15", new int[0], "", false, 0, 0, "hushou");
            config[402007] = new ItemConfig(402007, "羽扇", "法强+10", 1, "attr", "ap+10", new int[0], "", false, 0, 0, "yushan");
            config[402008] = new ItemConfig(402008, "名马", "生命+150", 1, "attr", "hp+150", new int[0], "", false, 0, 0, "ma1");
            config[409001] = new ItemConfig(409001, "火尖枪", "攻击+15", 5, "attr", "atk+15", new int[0], "", false, 0, 0, "huojianqiang");
            ...
            config[409005] = new ItemConfig(409005, "酒", "攻击+10，法强+6", 5, "attr", "atk+10,ap+6", new int[0], "", false, 0, 0, "jiu");
