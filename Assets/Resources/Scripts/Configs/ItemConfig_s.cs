...
namespace CommonConfig
{
    public class ItemConfig
    {
        ...
        {
            config.Clear();
            config[400001] = new ItemConfig(400001, "关王刀", "攻击+30，护甲+30", 2, "attr", "atk+30,armor+30", "atk", "", "", false, 0, 0, "guanwangdao");
            config[400002] = new ItemConfig(400002, "方天画戟", "攻击+30，暴击+22%", 2, "attr", "atk+30,crit+0.22", "atk", "", "", false, 0, 0, "fangtian");
            config[400003] = new ItemConfig(400003, "丈八蛇矛", "攻击+30，生命+250", 2, "attr", "atk+30,hp+250", "atk", "", "", false, 0, 0, "zhangba");
            config[400007] = new ItemConfig(400007, "孙子兵法", "法强+15，攻击+20", 2, "attr", "ap+15,atk+20", "ap", "", "", false, 0, 0, "sunzi");
            config[400008] = new ItemConfig(400008, "诗经", "法强+15，生命+250", 2, "attr", "ap+15,hp+250", "ap", "", "", false, 0, 0, "shijing");
            config[402009] = new ItemConfig(402009, "李广弓", "攻速+10%，法力回复+2", 2, "attr", "atkspeed+0.1,mpRegen+2", "atkspeed", "速射", "", false, 0, 0, "gong2");
            config[402010] = new ItemConfig(402010, "养由基弓", "攻速+15%，生命+250", 2, "attr", "atkspeed+0.15,hp+250", "atkspeed", "速射", "", false, 0, 0, "gong3");
            config[400011] = new ItemConfig(400011, "易经", "法强+10，法力回复+2", 2, "attr", "ap+10,mpRegen+2", "ap", "", "", false, 0, 0, "yijing");
            config[400012] = new ItemConfig(400012, "道德经", "法强+15，魔法抗性+30", 2, "attr", "ap+15,magicres+30", "ap", "", "", false, 0, 0, "daode");
            config[400013] = new ItemConfig(400013, "赤兔马", "攻速+15%，魔法抗性+30", 2, "attr", "atkspeed+0.15,magicres+30", "atkspeed", "", "", false, 0, 0, "chitu");
            config[400014] = new ItemConfig(400014, "的卢马", "生命+250，生命回复+2", 2, "attr", "hp+250,hpRegen+2", "hp", "", "", false, 0, 0, "dilu");
            config[400015] = new ItemConfig(400015, "长生镜", "生命+150", 1, "attr", "hp+150", "hp", "", "", false, 0, 0, "jingzi");
            config[400016] = new ItemConfig(400016, "飞羽甲", "护甲+30，攻速+15%", 2, "attr", "armor+30,atkspeed+0.15", "armor", "", "", false, 0, 0, "jia3");
            config[400017] = new ItemConfig(400017, "明光铠", "护甲+30，魔抗+30", 2, "attr", "armor+30,magicres+30", "armor", "", "", false, 0, 0, "jia2");
            config[400018] = new ItemConfig(400018, "兽面吞头铠", "护甲+30，暴击+22%", 2, "attr", "armor+30,crit+0.22", "armor", "", "", false, 0, 0, "jia4");
            config[400019] = new ItemConfig(400019, "八卦袍", "法强+15，护甲+30", 2, "attr", "ap+15,armor+30", "ap", "", "", false, 0, 0, "pao1");
            config[400020] = new ItemConfig(400020, "爪电飞黄", "护甲+30，生命+250", 2, "attr", "armor+30,hp+250", "armor", "", "", false, 0, 0, "ma3");
            config[400021] = new ItemConfig(400021, "穿云弓", "攻速+15%，暴击+22%", 2, "attr", "atkspeed+0.15,crit+0.22", "atkspeed", "", "", false, 0, 0, "gong4");
            config[400022] = new ItemConfig(400022, "白玉环", "暴击+22%，魔抗+30", 2, "attr", "crit+0.22,magicres+30", "crit", "", "", false, 0, 0, "huan1");
            config[400023] = new ItemConfig(400023, "玉龙壁", "魔抗+30，每秒回复2点法力", 2, "attr", "magicres+30,mpRegen+2", "magicres", "", "", false, 0, 0, "huan2");
            config[400024] = new ItemConfig(400024, "绝影", "生命+250，魔抗+30", 2, "attr", "hp+250,magicres+30", "hp", "", "", false, 0, 0, "ma2");
            config[400025] = new ItemConfig(400025, "古锭刀", "攻击+20，每秒回复2点法力", 2, "attr", "atk+20,mpRegen+2", "atk", "", "", false, 0, 0, "jian2");
            ...
            config[402003] = new ItemConfig(402003, "檀木弓", "攻速+10%", 1, "attr", "atkspeed+0.1", "atkspeed", "", "", false, 0, 0, "tanmugong");
            config[402004] = new ItemConfig(402004, "斗篷", "魔抗+20", 1, "attr", "magicres+20", "magicres", "", "", false, 0, 0, "doupeng");
