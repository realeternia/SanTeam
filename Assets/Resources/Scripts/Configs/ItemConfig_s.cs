...
namespace CommonConfig
{
    public class ItemConfig
    {
        ...
        public ItemConfig(int Id, string Name, string Des, int Lv, string Effect, string Attrs, int[] Skills, int RateAbs, int ShopIdx, bool AutoUse, bool AutoRemove, bool RemoveWhenUse, int StackLimit, int CombineId, int CombineNeed, int Price, float PriceRound, string Icon)
        {
            this.Id = Id;
            this.Name = Name;
            this.Des = Des;
        ...
        public static void Load()
        {
            ...
            config[401012] = new ItemConfig(401012, "万民书", "护甲+1，魔法抗性+1", 1, "tpattr", "armor+1,magicRes+1", new int[0], 0, 6, false, false, true, 99, 401013, 5, 6, 0.4f, "wanming1");
            config[401013] = new ItemConfig(401013, "万民书·精", "护甲+5，魔法抗性+5", 1, "tpattr", "armor+5,magicRes+5", new int[0], 0, 6, false, false, true, 99, 0, 0, 6, 0.4f, "wanming2");
