...
namespace CommonConfig
{
    public class JobConfig
    {
        ...
        public JobConfig(int Id, string Name, string NameS, int SkillId, int SourceJob)
        {
            this.Id = Id;
            this.Name = Name;
            this.NameS = NameS;
        ...
        public static void Load()
        {
            ...
            config[101] = new JobConfig(101, "ma", "马", 200005, 0);
            config[102] = new JobConfig(102, "mache", "车", 200011, 101);
            config[201] = new JobConfig(201, "gong", "弓", 200007, 0);
            config[202] = new JobConfig(202, "gongnu", "弩", 200010, 201);
            config[203] = new JobConfig(203, "gongpao", "炮", 200009, 201);
            config[301] = new JobConfig(301, "shi", "士", 200004, 0);
            config[302] = new JobConfig(302, "shidun", "盾", 0, 301);
            ...
            config[601] = new JobConfig(601, "dao", "刀", 200003, 0);
            config[602] = new JobConfig(602, "daoqiang", "枪", 200014, 601);
            config[603] = new JobConfig(603, "daoji", "戟", 200015, 601);
