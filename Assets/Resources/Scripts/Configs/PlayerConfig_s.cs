...
namespace CommonConfig
{
    public class PlayerConfig
    {
        ...
        public PlayerConfig(int Id, string Name, string Imgpath, string Colorstr, bool CanPlay, int InitGold, int[] InitCards, bool Banstrongcard, bool Banweakcard, float sameCardRate, int Cardherolimit, float Futurerate, float Findmasterrate, int Pickside, float FriendFactor, float OwnTooMuchCardRate)
        {
            this.Id = Id;
            this.Name = Name;
        ...
        {
            config.Clear();
            config[1] = new PlayerConfig(1, "旺仔", "PlayerPic/wang", "#00FF00", false, 0, new int[0], false, false, 0f, 0, 0f, 0f, 0, 0f, 0f);
            config[2] = new PlayerConfig(2, "布布", "PlayerPic/bubu", "#333333", true, 0, new int[0], true, false, 5f, 2, 0.6f, 1f, 0, 1f, 0.7f);
            config[3] = new PlayerConfig(3, "翔阳", "PlayerPic/xiangyang", "#FF8000", true, 0, new int[0], false, false, 3f, 2, 0.5f, 1f, 0, 1f, 0.7f);
            config[4] = new PlayerConfig(4, "屁屁", "PlayerPic/pp", "#F9BEB0", true, 0, new int[0], false, false, 3f, 1, 0.7f, 1f, 0, 1f, 0.7f);
            config[5] = new PlayerConfig(5, "八戒", "PlayerPic/bajie", "#FFCC99", true, 0, new int[0], true, false, 3f, 2, 0.28f, 1f, 0, 1f, 0.7f);
