...
namespace CommonConfig
{
    public class PlayerConfig
    {
        ...
        public static void Load()
        {
            ...
            config[3] = new PlayerConfig(3, "翔阳", "PlayerPic/xiangyang", "#FF8000", true, 0, null, false, false, 19, 30, 0.3f, 3f, 7, 7, 0.5f, 1f, 0, 0.5f, 1f, 0.5f, 0.5f, 0.8f, 0.3f, 0.7f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"1\"，\"shoot\"，\"1\""});
            ...
            config[9] = new PlayerConfig(9, "巴妈", "PlayerPic/bama", "#333333", true, 0, null, false, false, 19, 25, 0.3f, 3f, 9, 7, 0.35f, 1f, 0, 3f, 1.2f, 1f, 1f, 0.8f, 0.35f, 0.5f, new string[]{"\"shoot\"，\"2\"，\"def\"，\"2\""});
            config[100] = new PlayerConfig(100, "魔童", "PlayerPic/nezha", "#8C0000", false, -20, new int[]{409001}, false, true, 19, 30, 0.3f, 3f, 7, 7, 0.5f, 1f, 0, 2f, 0.5f, 0.5f, 0.5f, 0.84f, 0.23f, 0.9f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"1\""});
            config[101] = new PlayerConfig(101, "钱多", "PlayerPic/qian", "#FFFFFF", false, 25, new int[]{409002}, false, true, 22, 30, 0.1f, 5f, 8, 8, 0.525f, 1f, 0, 1f, 1.5f, 2f, 0.5f, 0.95f, 0.13f, 0.7f, new string[]{"\"shoot\"，\"1\"，\"help\"，\"2\"，\"def\"，\"1\""});
            config[102] = new PlayerConfig(102, "黄眉", "PlayerPic/huangmei", "#5555FF", false, -20, new int[]{100002,409004}, false, true, 19, 30, 0.2f, 3f, 7, 7, 0.5f, 2.5f, 2, 1f, 1.2f, 1.5f, 1.3f, 0.95f, 0.12f, 0.85f, new string[]{"\"inte\"，\"1\"，\"help\"，\"1\"，\"def\"，\"2\""});
            config[103] = new PlayerConfig(103, "无量", "PlayerPic/wuliang", "#FF3333", false, -20, new int[]{100003,409005}, false, true, 23, 30, 0.2f, 3f, 8, 8, 0.5f, 2.5f, 3, 2f, 0.5f, 0.5f, 0.5f, 0.85f, 0.2f, 0.9f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"1\"，\"shoot\"，\"1\""});
            config[104] = new PlayerConfig(104, "大虎", "PlayerPic/dahu", "#006633", false, -20, new int[]{100001,409003}, false, true, 19, 30, 0.3f, 3f, 7, 7, 0.5f, 3f, 1, 2f, 0.5f, 0.5f, 0.5f, 0.85f, 0.2f, 0.9f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"2\""});
