...
namespace CommonConfig
{
    public class PlayerConfig
    {
        ...
        public static void Load()
        {
            ...
            config[2] = new PlayerConfig(2, "布布", "PlayerPic/bubu", "#333333", true, 0, null, true, false, 2, 6, 0.1f, 5f, 8, 5, 0.6f, 1f, 0, 0.5f, 1f, 0.5f, 0.85f, 0.25f, 0.7f, new string[]{"\"def\"，\"2\"，\"inte\"，\"1\"，\"shoot\"，\"1\""});
            config[3] = new PlayerConfig(3, "翔阳", "PlayerPic/xiangyang", "#FF8000", true, 0, null, false, false, 8, 12, 0.3f, 3f, 7, 6, 0.5f, 1f, 0, 0.5f, 1f, 0.5f, 0.8f, 0.3f, 0.7f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"1\"，\"shoot\"，\"1\""});
            config[4] = new PlayerConfig(4, "屁屁", "PlayerPic/pp", "#F9BEB0", true, 0, null, false, false, 8, 12, 0.2f, 3f, 7, 6, 0.7f, 1f, 0, 0.5f, 1f, 0.5f, 0.8f, 0.3f, 0.7f, new string[]{"\"def\"，\"1\"，\"help\"，\"1\"，\"inte\"，\"3\""});
            config[5] = new PlayerConfig(5, "八戒", "PlayerPic/bajie", "#FFCC99", true, 0, null, true, false, 8, 12, 0.3f, 3f, 8, 6, 0.28f, 1f, 0, 1f, 1f, 0.5f, 0.85f, 0.25f, 0.7f, new string[]{"\"atk\"，\"2\"，\"shoot\"，\"1\""});
            config[6] = new PlayerConfig(6, "艾沙", "PlayerPic/aisha", "#2BD9F9", true, 0, null, false, true, 8, 12, 0.3f, 3f, 9, 6, 0.2f, 1f, 0, 0.5f, 0.65f, 0.3f, 0.8f, 0.3f, 0.7f, new string[]{"\"inte\"，\"3\""});
            config[8] = new PlayerConfig(8, "巴爸", "PlayerPic/baba", "#FF73FF", true, 0, null, false, false, 7, 9, 0.3f, 3f, 8, 6, 0.28f, 1f, 0, 0.5f, 1f, 0.5f, 0.85f, 0.25f, 0.85f, new string[]{"\"atk\"，\"1\"，\"def\"，\"1\"，\"inte\"，\"1\"，\"shoot\"，\"1\""});
            config[9] = new PlayerConfig(9, "巴妈", "PlayerPic/bama", "#333333", true, 0, null, false, false, 8, 10, 0.3f, 3f, 9, 6, 0.35f, 1f, 0, 3f, 1.2f, 1f, 0.8f, 0.35f, 0.5f, new string[]{"\"shoot\"，\"2\"，\"def\"，\"2\""});
