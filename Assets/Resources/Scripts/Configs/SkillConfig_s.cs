...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            config[200002] = new SkillConfig(200002, "车愤怒一击", 1, 0.25f, 5f, 0.75f, 0, 0, "CriticalAttack", "SwordHitRedCritical", 2, "crtattack");
            config[200003] = new SkillConfig(200003, "主公技", 1, 0, 0, 0.25f, 300001, 999, "MasterShield", "", 2, "");
