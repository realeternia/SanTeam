...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            config[201010] = new SkillConfig(201010, "旋风斩", "旋", "攻击时几率对附近敌人造成伤害", "技", 1, 0.4f, 5f, 0, 0, "str", null, 25f, false, "", 99, 0, 0, 0, 0.8f, 0, 0, 0, 0, "", "", 0, false, 0, 0, 0, 0, 0, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0, 3, "meng");
            config[201011] = new SkillConfig(201011, "落雷", "天", "攻击召唤出持续伤害的雷电阵", "术", 1, 0.3f, 10f, 0, 0, "inte", null, 0, false, "", 1, 0, 0, 0, 0, 0.15f, 0, 0, 0, "", "", 0, false, 0, 0, 25f, 5.2f, 0.5f, 0, "HitRegion", "spin", "SummonStorm", 5f, 4, "tian");
            config[201012] = new SkillConfig(201012, "火计", "火", "攻击时对目标放火", "技", 1, 0.3f, 5f, 0, 0, "inte", null, 0, false, "", 1, 0, 0, 0, 0, 0.1f, 0, 0, 0, "", "", 0, false, 0, 1, 8f, 3.2f, 1f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, 2, "huo");
            config[201013] = new SkillConfig(201013, "火墙", "炎", "攻击召唤出持续伤害的火墙", "术", 1, 0.3f, 8f, 0, 0, "inte", null, 0, false, "", 1, 0, 0, 0, 0, 0.08f, 0, 0, 0, "", "", 0, false, 0, 5, 8f, 3.2f, 1f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, 4, "yan");
            config[201014] = new SkillConfig(201014, "飞斧", "斧", "扔出飞斧攻击前方敌人", "技", 1, 1f, 5.7f, 2f, 0, "str", null, 45f, false, "", 99, 0, 0, 0, 0, 0.4f, 0, 0, 0, "", "", 0, false, 0, 0, 9f, 1.5f, 0, 40f, "AidShockWave", "spin", "AxeExplosion", 3f, 2, "fu3");
            config[201015] = new SkillConfig(201015, "驰羽", "羽", "能够射出箭矢", "技", 1, 1f, 6f, 2f, 0, "leadShip", null, 42f, false, "", 0, 0, 0, 0, 0, 0.75f, 0, 0, 0, "", "", 0, false, 0, 0, 0, 0, 0, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, 2, "yu");
            config[201016] = new SkillConfig(201016, "惊雷", "雷", "召唤3个惊雷攻击前方敌人", "术", 1, 1f, 4.8f, 2f, 0, "inte", null, 65f, false, "", 99, 0, 0, 0, 0, 0.4f, 0, 0, 0, "", "", 0, false, 0, 0, 11f, 2f, 0, 40f, "AidShockWave", "spin", "NukeMissileFires", 4f, 3, "lei");
            ...
            config[201021] = new SkillConfig(201021, "火矢", "矢", "攻击时射出火箭", "技", 1, 0.35f, 3f, 0, 0, "str", null, 0, false, "", 1, 0, 0, 0, 0, 0.12f, 0, 0, 0, "", "", 0, false, 0, 1, 8f, 3.2f, 1f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, 2, "shi3");
            ...
            config[201024] = new SkillConfig(201024, "虐袭", "虐", "攻击护盾敌人时造成额外伤害", "技", 1, 0, 0, 0, 0, "str", null, 0, false, "", 0, 0.5f, 0, 0, 0, 0, 0, 0, 0, "", "", 300001, false, 0, 0, 0, 0, 0, 0, "AttackAntiShield", "sway", "", 0, 1, "nue");
            ...
            config[203005] = new SkillConfig(203005, "击破", "破", "使目标增伤40%", "", 1, 0.4f, 2f, 0, 0, "str", null, 0, false, "", 0, 0.4f, 0, 0, 0, 0, 0, 0, 0, "", "", 301003, false, 3f, 0, 0, 0, 0, 0, "HitBuff", "jump", "SoftFireBigRed", 0, 2, "po");
            config[203006] = new SkillConfig(203006, "延缓", "缓", "使目标减速30%", "", 1, 0.4f, 3f, 0, 0, "inte", null, 0, false, "", 0, 0.3f, 0, 0, 0, 0, 0, 0, 0, "", "", 301004, false, 5f, 0, 0, 0, 0, 0, "HitBuff", "sway", "MagicNovaYellow", 0, 2, "huan");
            config[203007] = new SkillConfig(203007, "分兵", "分", "被攻击时产生一只有伤害部队", "", 1, 0.4f, 15f, 0, 0, "leadShip", null, 15f, false, "", 0, 0, 0, 0.5f, 0.5f, 0, 4, 0, 0, "", "", 0, false, 0, 0, 0, 0, 0, 0, "AttackedShadow", "sway", "MagicFieldGreen", 0, 3, "fen2");
            config[203008] = new SkillConfig(203008, "分兵小", "纷", "被攻击时产生一只无伤害部队", "", 1, 0.4f, 15f, 0, 0, "leadShip", null, 15f, false, "", 0, 0, 0, 0.4f, 0.01f, 0, 4, 0, 0, "", "", 0, false, 0, 0, 0, 0, 0, 0, "AttackedShadow", "sway", "MagicFieldGreen", 0, 2, "fen3");
            ...
            config[208008] = new SkillConfig(208008, "曲扬", "曲", "正面祝福状态时间增加50%", "智技up", 1, 0, 0, 0, 0, "inte", new string[]{"inte"}, 0, false, "", 0, 0.5f, 0, 0, 0, 0, 0, 0, 0, "", "", 0, false, 0, 0, 0, 0, 0, 0, "ModifyBuffTime", "", "", 0, 1, "qu");
