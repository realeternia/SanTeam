...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            config[2010001] = new SkillConfig(2010001, "突破", "突", "攻击时穿越敌人，造成/1额外伤害", "50", "连接", "", 1, 1f, 5f, 0, "", 0f, false, "", 0, 0f, 0f, "", 0, 50f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackRunCross", "", "LightningExplosionBlue", 0f, "tu", "", "", "");
            config[2010002] = new SkillConfig(2010002, "突破", "突", "", "100", "连接", "", 2, 1f, 5f, 0, "", 0f, false, "", 0, 0f, 0f, "", 0, 100f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackRunCross", "", "LightningExplosionBlue", 0f, "tu", "", "", "");
            config[2010003] = new SkillConfig(2010003, "突破", "突", "", "150", "连接", "", 3, 1f, 5f, 0, "", 0f, false, "", 0, 0f, 0f, "", 0, 150f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackRunCross", "", "LightningExplosionBlue", 0f, "tu", "", "", "");
            config[2010004] = new SkillConfig(2010004, "突破", "突", "", "200", "连接", "", 4, 1f, 5f, 0, "", 0f, false, "", 0, 0f, 0f, "", 0, 200f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackRunCross", "", "LightningExplosionBlue", 0f, "tu", "", "", "");
            config[2010005] = new SkillConfig(2010005, "突破", "突", "", "250", "连接", "", 5, 1f, 5f, 0, "", 0f, false, "", 0, 0f, 0f, "", 0, 250f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackRunCross", "", "LightningExplosionBlue", 0f, "tu", "", "", "");
            ...
            config[2010016] = new SkillConfig(2010016, "火攻", "火", "攻击时/1几率对目标放火，若目标有火则传递，造成/2法术伤害", "20%;30", "连接", "", 1, 0.2f, 4f, 0, "", 0f, true, "", 0, 0f, 30f, "", 1, 30f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitFireArea", "throw", "SoftFireBigRed", 1.6f, "huo", "", "", "");
            config[2010017] = new SkillConfig(2010017, "火攻", "火", "", "25%;40", "连接", "", 2, 0.25f, 4f, 0, "", 0f, true, "", 0, 0f, 30f, "", 1, 40f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitFireArea", "throw", "SoftFireBigRed", 1.6f, "huo", "", "", "");
            config[2010018] = new SkillConfig(2010018, "火攻", "火", "", "30%;50", "连接", "", 3, 0.3f, 4f, 0, "", 0f, true, "", 0, 0f, 30f, "", 1, 50f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitFireArea", "throw", "SoftFireBigRed", 1.6f, "huo", "", "", "");
            config[2010019] = new SkillConfig(2010019, "火攻", "火", "", "35%;60", "连接", "", 4, 0.35f, 4f, 0, "", 0f, true, "", 0, 0f, 30f, "", 1, 60f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitFireArea", "throw", "SoftFireBigRed", 1.6f, "huo", "", "", "");
            config[2010020] = new SkillConfig(2010020, "火攻", "火", "", "40%;70", "连接", "", 5, 0.4f, 4f, 0, "", 0f, true, "", 0, 0f, 30f, "", 1, 70f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitFireArea", "throw", "SoftFireBigRed", 1.6f, "huo", "", "", "");
            ...
            config[2010026] = new SkillConfig(2010026, "冷箭", "冷", "能够射出冷箭，造成/1伤害", "80", "连接", "", 1, 1f, 4f, 0, "", 1f, false, "", 0, 30f, 0f, "", 0, 80f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "leng", "", "", "");
            config[2010027] = new SkillConfig(2010027, "冷箭", "冷", "", "120", "连接", "", 2, 1f, 4f, 0, "", 1f, false, "", 0, 40f, 0f, "", 0, 120f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "leng", "", "", "");
            config[2010028] = new SkillConfig(2010028, "冷箭", "冷", "", "160", "连接", "", 3, 1f, 4f, 0, "", 1f, false, "", 0, 50f, 0f, "", 0, 160f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "leng", "", "", "");
            config[2010029] = new SkillConfig(2010029, "冷箭", "冷", "", "200", "连接", "", 4, 1f, 4f, 0, "", 1f, false, "", 0, 60f, 0f, "", 0, 200f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "leng", "", "", "");
            config[2010030] = new SkillConfig(2010030, "冷箭", "冷", "", "250", "连接", "", 5, 1f, 4f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, 250f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "leng", "", "", "");
            ...
            config[2010061] = new SkillConfig(2010061, "护卫", "护", "给生命比例最低的友方英雄减伤盾，护盾值=自身最大生命的/1", "10%", "连接", "", 1, 1f, 8f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, .1f, 0, 0f, 0, "", "", "盾", false, 999f, "", 0, 0f, 0f, 0f, 0, "AidBuffLowHp", "sway", "MagicChargeYellow", 0f, "hu", "", "", "");
            config[2010062] = new SkillConfig(2010062, "护卫", "护", "", "15%", "连接", "", 2, 1f, 8f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, .15f, 0, 0f, 0, "", "", "盾", false, 999f, "", 0, 0f, 0f, 0f, 0, "AidBuffLowHp", "sway", "MagicChargeYellow", 0f, "hu", "", "", "");
            config[2010063] = new SkillConfig(2010063, "护卫", "护", "", "20%", "连接", "", 3, 1f, 8f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, .2f, 0, 0f, 0, "", "", "盾", false, 999f, "", 0, 0f, 0f, 0f, 0, "AidBuffLowHp", "sway", "MagicChargeYellow", 0f, "hu", "", "", "");
            config[2010064] = new SkillConfig(2010064, "护卫", "护", "", "25%", "连接", "", 4, 1f, 8f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, .25f, 0, 0f, 0, "", "", "盾", false, 999f, "", 0, 0f, 0f, 0f, 0, "AidBuffLowHp", "sway", "MagicChargeYellow", 0f, "hu", "", "", "");
            config[2010065] = new SkillConfig(2010065, "护卫", "护", "", "30%", "连接", "", 5, 1f, 8f, 0, "", 1f, false, "", 0, 80f, 0f, "", 0, .3f, 0, 0f, 0, "", "", "盾", false, 999f, "", 0, 0f, 0f, 0f, 0, "AidBuffLowHp", "sway", "MagicChargeYellow", 0f, "hu", "", "", "");
            ...
            config[2010071] = new SkillConfig(2010071, "偷袭", "偷", "战斗开始突袭随机敌方英雄，造成/1的魔法伤害，/2概率交换位置", "100;30%", "连接", "", 1, 0.3f, 0f, 0, "", 0f, true, "", 0, 0f, 0f, "", 0, 100f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "InitSneakChangePos", "", "MagicNovaBlue", 0f, "tou", "", "", "");
            config[2010072] = new SkillConfig(2010072, "偷袭", "偷", "", "150;35%", "连接", "", 2, 0.35f, 0f, 0, "", 0f, true, "", 0, 0f, 0f, "", 0, 150f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "InitSneakChangePos", "", "MagicNovaBlue", 0f, "tou", "", "", "");
            config[2010073] = new SkillConfig(2010073, "偷袭", "偷", "", "200;40%", "连接", "", 3, 0.4f, 0f, 0, "", 0f, true, "", 0, 0f, 0f, "", 0, 200f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "InitSneakChangePos", "", "MagicNovaBlue", 0f, "tou", "", "", "");
            config[2010074] = new SkillConfig(2010074, "偷袭", "偷", "", "250;45%", "连接", "", 4, 0.45f, 0f, 0, "", 0f, true, "", 0, 0f, 0f, "", 0, 250f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "InitSneakChangePos", "", "MagicNovaBlue", 0f, "tou", "", "", "");
            config[2010075] = new SkillConfig(2010075, "偷袭", "偷", "", "300;50%", "连接", "", 5, 0.5f, 0f, 0, "", 0f, true, "", 0, 0f, 0f, "", 0, 300f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "InitSneakChangePos", "", "MagicNovaBlue", 0f, "tou", "", "", "");
            ...
            config[2020001] = new SkillConfig(2020001, "强击", "强", "对目标造成法强/1的魔法伤害", "60", "技", "", 1, 1f, 1f, 12, "", 0f, true, "", 0, 30f, 0f, "", 1, 60f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "", "", "", "");
            config[2020002] = new SkillConfig(2020002, "强击", "强", "", "120", "技", "", 2, 1f, 1f, 12, "", 0f, true, "", 0, 30f, 0f, "", 1, 120f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "", "", "", "");
            config[2020003] = new SkillConfig(2020003, "强击", "强", "", "180", "技", "", 3, 1f, 1f, 12, "", 0f, true, "", 0, 30f, 0f, "", 1, 180f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "", "", "", "");
            config[2020004] = new SkillConfig(2020004, "强击", "强", "", "240", "技", "", 4, 1f, 1f, 12, "", 0f, true, "", 0, 30f, 0f, "", 1, 240f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "", "", "", "");
            config[2020005] = new SkillConfig(2020005, "强击", "强", "", "300", "技", "", 5, 1f, 1f, 12, "", 0f, true, "", 0, 30f, 0f, "", 1, 300f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AidSuddenArrow", "sway", "BulletExplosionBlue", 3f, "", "", "", "");
            config[2020216] = new SkillConfig(2020216, "共杀", "徐晃", "攻击时对目标周围/1个敌人弹射/2攻击伤害", "2;30%", "技", "", 1, 0f, 3f, 10, "", 0f, true, "", 0, 30f, 0f, "", 2, .3f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            config[2020217] = new SkillConfig(2020217, "共杀", "徐晃", "", "3;35%", "技", "", 2, 0f, 3f, 10, "", 0f, true, "", 0, 30f, 0f, "", 3, .35f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            config[2020218] = new SkillConfig(2020218, "共杀", "徐晃", "", "3;40%", "技", "", 3, 0f, 3f, 10, "", 0f, true, "", 0, 30f, 0f, "", 3, .4f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            config[2020219] = new SkillConfig(2020219, "共杀", "徐晃", "", "4;50%", "技", "", 4, 0f, 3f, 10, "", 0f, true, "", 0, 30f, 0f, "", 4, .5f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            config[2020220] = new SkillConfig(2020220, "共杀", "徐晃", "", "4;60%", "技", "", 5, 0f, 3f, 10, "", 0f, true, "", 0, 30f, 0f, "", 4, .6f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            config[2020221] = new SkillConfig(2020221, "旋风斩", "张飞", "攻击时对周围最多/1个敌人造成/2攻击伤害", "3;50%", "技", "", 1, 0f, 5f, 15, "", 0f, true, "", 0, 25f, 0f, "", 3, .5f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0f, "", "", "", "");
            config[2020222] = new SkillConfig(2020222, "旋风斩", "张飞", "", "3;60%", "技", "", 2, 0f, 5f, 15, "", 0f, true, "", 0, 25f, 0f, "", 3, .6f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0f, "", "", "", "");
            config[2020223] = new SkillConfig(2020223, "旋风斩", "张飞", "", "4;70%", "技", "", 3, 0f, 5f, 15, "", 0f, true, "", 0, 25f, 0f, "", 4, .7f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0f, "", "", "", "");
            config[2020224] = new SkillConfig(2020224, "旋风斩", "张飞", "", "4;80%", "技", "", 4, 0f, 5f, 15, "", 0f, true, "", 0, 25f, 0f, "", 4, .8f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0f, "", "", "", "");
            config[2020225] = new SkillConfig(2020225, "旋风斩", "张飞", "", "4;100%", "技", "", 5, 0f, 5f, 15, "", 0f, true, "", 0, 25f, 0f, "", 4, 1f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", 0f, "", "", "", "");
            config[2020226] = new SkillConfig(2020226, "落雷", "张角", "攻击召唤持续伤害雷电阵，每秒造成/1法术伤害", "25", "术", "", 1, 0f, 8f, 18, "", 0f, true, "", 0, 0f, 25f, "", 4, 25f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 5.2f, 1f, 0f, 0, "HitRegion", "spin", "SummonStorm", 5f, "", "", "", "");
            config[2020227] = new SkillConfig(2020227, "落雷", "张角", "", "40", "术", "", 2, 0f, 8f, 18, "", 0f, true, "", 0, 0f, 25f, "", 4, 40f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 5.2f, 1f, 0f, 0, "HitRegion", "spin", "SummonStorm", 5f, "", "", "", "");
            config[2020228] = new SkillConfig(2020228, "落雷", "张角", "", "55", "术", "", 3, 0f, 8f, 18, "", 0f, true, "", 0, 0f, 25f, "", 4, 55f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 5.2f, 1f, 0f, 0, "HitRegion", "spin", "SummonStorm", 5f, "", "", "", "");
            config[2020229] = new SkillConfig(2020229, "落雷", "张角", "", "70", "术", "", 4, 0f, 8f, 18, "", 0f, true, "", 0, 0f, 25f, "", 4, 70f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 5.2f, 1f, 0f, 0, "HitRegion", "spin", "SummonStorm", 5f, "", "", "", "");
            config[2020230] = new SkillConfig(2020230, "落雷", "张角", "", "90", "术", "", 5, 0f, 8f, 18, "", 0f, true, "", 0, 0f, 25f, "", 4, 90f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 5.2f, 1f, 0f, 0, "HitRegion", "spin", "SummonStorm", 5f, "", "", "", "");
            config[2020121] = new SkillConfig(2020121, "火计", "钬", "攻击时对目标放火", "", "术", "", 1, 0.3f, 5f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 10f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020122] = new SkillConfig(2020122, "火计", "钬", "", "", "术", "", 2, 0.3f, 5f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 15f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020123] = new SkillConfig(2020123, "火计", "钬", "", "", "术", "", 3, 0.3f, 5f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 20f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020124] = new SkillConfig(2020124, "火计", "钬", "", "", "术", "", 4, 0.3f, 5f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 25f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020125] = new SkillConfig(2020125, "火计", "钬", "", "", "术", "", 5, 0.3f, 5f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 30f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020141] = new SkillConfig(2020141, "飞斧", "许褚", "扔出飞斧攻击前方敌人，造成/1伤害", "50", "技", "", 1, 1f, 5f, 15, "", 2f, true, "", 0, 45f, 9f, "", 4, 50f, 0, 0f, 0, "", "", "", false, 0f, "武", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "AxeExplosion", 3f, "", "", "", "");
            config[2020142] = new SkillConfig(2020142, "飞斧", "许褚", "", "80", "技", "", 2, 1f, 5f, 15, "", 2f, true, "", 0, 45f, 9f, "", 4, 80f, 0, 0f, 0, "", "", "", false, 0f, "武", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "AxeExplosion", 3f, "", "", "", "");
            config[2020143] = new SkillConfig(2020143, "飞斧", "许褚", "", "110", "技", "", 3, 1f, 5f, 15, "", 2f, true, "", 0, 45f, 9f, "", 4, 110f, 0, 0f, 0, "", "", "", false, 0f, "武", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "AxeExplosion", 3f, "", "", "", "");
            config[2020144] = new SkillConfig(2020144, "飞斧", "许褚", "", "160", "技", "", 4, 1f, 5f, 15, "", 2f, true, "", 0, 45f, 9f, "", 4, 160f, 0, 0f, 0, "", "", "", false, 0f, "武", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "AxeExplosion", 3f, "", "", "", "");
            config[2020145] = new SkillConfig(2020145, "飞斧", "许褚", "", "220", "技", "", 5, 1f, 5f, 15, "", 2f, true, "", 0, 45f, 9f, "", 4, 220f, 0, 0f, 0, "", "", "", false, 0f, "武", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "AxeExplosion", 3f, "", "", "", "");
            config[2020161] = new SkillConfig(2020161, "惊雷", "鲁肃", "召唤3个惊雷攻击前方敌人，造成/1法术伤害", "100", "术", "", 1, 1f, 5f, 18, "", 2f, true, "", 0, 60f, 11f, "", 4, 100f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "NukeMissileFires", 4f, "", "", "", "");
            config[2020162] = new SkillConfig(2020162, "惊雷", "鲁肃", "", "140", "术", "", 2, 1f, 5f, 18, "", 2f, true, "", 0, 60f, 11f, "", 4, 140f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "NukeMissileFires", 4f, "", "", "", "");
            config[2020163] = new SkillConfig(2020163, "惊雷", "鲁肃", "", "180", "术", "", 3, 1f, 5f, 18, "", 2f, true, "", 0, 60f, 11f, "", 4, 180f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "NukeMissileFires", 4f, "", "", "", "");
            config[2020164] = new SkillConfig(2020164, "惊雷", "鲁肃", "", "230", "术", "", 4, 1f, 5f, 18, "", 2f, true, "", 0, 60f, 11f, "", 4, 230f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "NukeMissileFires", 4f, "", "", "", "");
            config[2020165] = new SkillConfig(2020165, "惊雷", "鲁肃", "", "300", "术", "", 5, 1f, 5f, 18, "", 2f, true, "", 0, 60f, 11f, "", 4, 300f, 0, 0f, 0, "", "", "", false, 0f, "雷", 0, 1.5f, 0f, 40f, 0, "AidShockWave", "spin", "NukeMissileFires", 4f, "", "", "", "");
            config[2020191] = new SkillConfig(2020191, "魔神", "吕布", "对目标造成伤害并吸取造成/1伤害，并回复等量生命", "100", "", "", 1, 0f, 6f, 20, "", 0f, true, "", 0, 10f, 0f, "", 1, 100f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0.6f, 0f, 15f, 0, "AidDrain", "", "MagicBuffGreen", 3f, "", "", "", "");
            config[2020192] = new SkillConfig(2020192, "魔神", "吕布", "", "180", "", "", 2, 0f, 6f, 20, "", 0f, true, "", 0, 10f, 0f, "", 1, 180f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0.6f, 0f, 15f, 0, "AidDrain", "", "MagicBuffGreen", 3f, "", "", "", "");
            config[2020193] = new SkillConfig(2020193, "魔神", "吕布", "", "250", "", "", 3, 0f, 6f, 20, "", 0f, true, "", 0, 10f, 0f, "", 1, 250f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0.6f, 0f, 15f, 0, "AidDrain", "", "MagicBuffGreen", 3f, "", "", "", "");
            config[2020194] = new SkillConfig(2020194, "魔神", "吕布", "", "350", "", "", 4, 0f, 6f, 20, "", 0f, true, "", 0, 10f, 0f, "", 1, 350f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0.6f, 0f, 15f, 0, "AidDrain", "", "MagicBuffGreen", 3f, "", "", "", "");
            config[2020195] = new SkillConfig(2020195, "魔神", "吕布", "", "500", "", "", 5, 0f, 6f, 20, "", 0f, true, "", 0, 10f, 0f, "", 1, 500f, 0, 0f, 0, "", "", "", false, 0f, "", 0, 0.6f, 0f, 15f, 0, "AidDrain", "", "MagicBuffGreen", 3f, "", "", "", "");
            config[2020201] = new SkillConfig(2020201, "埋伏", "伏", "被攻击时瞬移到远程攻击者附近", "", "", "", 1, 1f, 6f, 0, "", 0f, true, "", 0, 30f, 0f, "", 0, 0f, 0, 0f, 0, "", "", "乱", false, 1f, "", 0, 0f, 0f, 0f, 0, "HitTeleport", "saw", "MagicNovaBlue", 0f, "", "", "", "");
            ...
            config[2020206] = new SkillConfig(2020206, "火墙", "周瑜", "攻击召唤出持续伤害的火墙，造成每秒/1伤害", "25", "术", "", 1, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 25f, 0, 0f, 0, "", "", "", false, 0f, "火", 5, 3.2f, 1f, 0f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020207] = new SkillConfig(2020207, "火墙", "周瑜", "", "40", "术", "", 2, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 40f, 0, 0f, 0, "", "", "", false, 0f, "火", 5, 3.2f, 1f, 0f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020208] = new SkillConfig(2020208, "火墙", "周瑜", "", "60", "术", "", 3, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 60f, 0, 0f, 0, "", "", "", false, 0f, "火", 5, 3.2f, 1f, 0f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020209] = new SkillConfig(2020209, "火墙", "周瑜", "", "80", "术", "", 4, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 80f, 0, 0f, 0, "", "", "", false, 0f, "火", 5, 3.2f, 1f, 0f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020210] = new SkillConfig(2020210, "火墙", "周瑜", "", "110", "术", "", 5, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 8f, "", 1, 110f, 0, 0f, 0, "", "", "", false, 0f, "火", 5, 3.2f, 1f, 0f, 0, "HitWall", "spin", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020211] = new SkillConfig(2020211, "火矢", "黄忠", "攻击时射出火箭，造成每秒/1伤害", "40", "技", "", 1, 0f, 0f, 12, "", 0f, true, "", 0, 0f, 8f, "", 1, 40f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020212] = new SkillConfig(2020212, "火矢", "黄忠", "", "60", "技", "", 2, 0f, 0f, 12, "", 0f, true, "", 0, 0f, 8f, "", 1, 60f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020213] = new SkillConfig(2020213, "火矢", "黄忠", "", "80", "技", "", 3, 0f, 0f, 12, "", 0f, true, "", 0, 0f, 8f, "", 1, 80f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020214] = new SkillConfig(2020214, "火矢", "黄忠", "", "100", "技", "", 4, 0f, 0f, 12, "", 0f, true, "", 0, 0f, 8f, "", 1, 100f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2020215] = new SkillConfig(2020215, "火矢", "黄忠", "", "120", "技", "", 5, 0f, 0f, 12, "", 0f, true, "", 0, 0f, 8f, "", 1, 120f, 0, 0f, 0, "", "", "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            config[2030021] = new SkillConfig(2030021, "连锁", "庞统", "锁定目标范围敌人，扩散/1伤害，范围/2", "40%;40", "术", "", 1, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 40f, "targetUnit", 3, 0f, 0, 0.4f, 0, "", "", "锁", false, 8f, "", 0, 0f, 0f, 0f, 0, "HitBuffArea", "throw", "MagicNovaYellow", 0f, "", "", "", "");
            config[2030022] = new SkillConfig(2030022, "连锁", "庞统", "", "50%;50", "术", "", 2, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 50f, "targetUnit", 3, 0f, 0, 0.5f, 0, "", "", "锁", false, 8f, "", 0, 0f, 0f, 0f, 0, "HitBuffArea", "throw", "MagicNovaYellow", 0f, "", "", "", "");
            config[2030023] = new SkillConfig(2030023, "连锁", "庞统", "", "60%;60", "术", "", 3, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 60f, "targetUnit", 3, 0f, 0, 0.6f, 0, "", "", "锁", false, 8f, "", 0, 0f, 0f, 0f, 0, "HitBuffArea", "throw", "MagicNovaYellow", 0f, "", "", "", "");
            config[2030024] = new SkillConfig(2030024, "连锁", "庞统", "", "70%;70", "术", "", 4, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 70f, "targetUnit", 3, 0f, 0, 0.7f, 0, "", "", "锁", false, 8f, "", 0, 0f, 0f, 0f, 0, "HitBuffArea", "throw", "MagicNovaYellow", 0f, "", "", "", "");
            config[2030025] = new SkillConfig(2030025, "连锁", "庞统", "", "80%;80", "术", "", 5, 0f, 0f, 20, "", 0f, true, "", 0, 0f, 80f, "targetUnit", 3, 0f, 0, 0.8f, 0, "", "", "锁", false, 8f, "", 0, 0f, 0f, 0f, 0, "HitBuffArea", "throw", "MagicNovaYellow", 0f, "", "", "", "");
