...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            config[2020211] = new SkillConfig(2020211, "火矢", "黄忠", "攻击时射出火箭，造成每秒/strength伤害", "技", 1, 0f, 0f, 12, "", 0, "", 0f, 8f, "", 1, 40f, 0f, 0, "", false, 0f, "火", 1, 3.2f, 1f, 0f, 0, "HitWall", "throw", "SoftFireBigRed", 1.6f, "", "", "", "");
            ...
            config[2020216] = new SkillConfig(2020216, "共杀", "徐晃", "攻击时对目标周围/targetcount个敌人弹射/strength%攻击伤害", "技", 1, 0f, 3f, 10, "", 0, "", 30f, 0f, "", 2, .3f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "AttackReboundArrow", "flipspin", "", 0f, "", "", "", "");
            ...
            // ==================== 相职业武将专属技能（Id 2020351~2020385，空段） ====================
            // 蒋琬·抚军：战斗开始给本侧近战士兵套盾 + 每次释放额外给1名近战士兵套盾（护盾=最大生命×Strength，复用 BuffShield）
            ...
            // 马良·励军：每次释放，本侧所有士兵攻击+X%、护甲+Y（永久可叠）
            ...
            // 张昭·筑垒：每次释放对1名士兵，永久强化双防+回复满血；该士兵死亡3秒原地复活(仅一次)
            ...
            // 贾诩·乱阵(主动释放)：对目标造成法术伤害+眩晕；战斗开始给本侧近战士兵附加普攻眩晕 Buff(BuffHitStun)
            ...
            // 沮授·强弓：每次释放，本侧弓兵及自身攻击+X%、攻速+Y%（永久可叠）
            ...
            // 荀彧·兵精：对一名士兵大祝福(优先近战)：回复满血 + 攻/护甲/魔抗大幅提升，每名士兵整场合仅一次
