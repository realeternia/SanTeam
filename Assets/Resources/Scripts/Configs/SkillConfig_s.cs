...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        {
            config.Clear();
            config[200001] = new SkillConfig(200001, "主公技", "给与我方同阵营单位20%生命值护盾", 1, 0, 0, "", 0, 0, 0, false, 0, 0.2f, 0, 0, 300001, 999f, 0, 0, 0, "MasterShield", "", 4, "shuai");
            config[200003] = new SkillConfig(200003, "愤怒一击", "攻击几率造成1.5倍伤害", 1, 0.1f, 5f, "leadShip", 0.1f, 0.01f, 0, false, 0, 0.5f, 0, 0, 0, 0, 0, 0, 0, "CriticalAttack", "SwordHitRedCritical", 1, "dao");
            ...
            config[200011] = new SkillConfig(200011, "冲锋", "移动时穿越敌人,降低目标防御", 1, 1f, 7f, "", 0, 0, 20f, false, 0, 0.12f, 0, 0, 301003, 3f, 0, 0, 0, "RunCrossPlus", "LightningExplosionRed", 4, "che");
            ...
            config[201014] = new SkillConfig(201014, "连锁", "锁定敌人目标,传递一半受到伤害", 1, 0.5f, 3f, "inte", 0, 0, 25f, false, 1, 0.5f, 0, 0, 301002, 8f, 0, 0, 0, "HitBuffArea", "", 4, "suo");
