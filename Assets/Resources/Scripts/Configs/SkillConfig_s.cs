...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            // ===== 关羽·分兵 2020601~2020605（SkillAidShadowSplit，法术）=====
            config[2020601] = new SkillConfig(2020601, "分兵", "关羽", "召唤/summoncount名影分身冲击敌人（继承自身/strength2攻击与生命），同时本体对目标造成/strength法术伤害", "术", 1, 0f, 6f, 18, "", 0, "", 60f, 25f, "", 1, 35f, 0.25f, 0, "", false, 0f, "", 1, 0f, 0f, 0f, 0, "SkillAidShadowSplit", "sway", "MagicChargeYellow", 0f, "guanyu", "", "", "");
            config[2020602] = new SkillConfig(2020602, "分兵", "关羽", "", "术", 2, 0f, 6f, 18, "", 0, "", 60f, 25f, "", 1, 55f, 0.30f, 0, "", false, 0f, "", 1, 0f, 0f, 0f, 0, "SkillAidShadowSplit", "sway", "MagicChargeYellow", 0f, "guanyu", "", "", "");
            config[2020603] = new SkillConfig(2020603, "分兵", "关羽", "", "术", 3, 0f, 6f, 18, "", 0, "", 60f, 25f, "", 1, 80f, 0.35f, 0, "", false, 0f, "", 1, 0f, 0f, 0f, 0, "SkillAidShadowSplit", "sway", "MagicChargeYellow", 0f, "guanyu", "", "", "");
            config[2020604] = new SkillConfig(2020604, "分兵", "关羽", "", "术", 4, 0f, 6f, 18, "", 0, "", 60f, 25f, "", 1, 110f, 0.40f, 0, "", false, 0f, "", 1, 0f, 0f, 0f, 0, "SkillAidShadowSplit", "sway", "MagicChargeYellow", 0f, "guanyu", "", "", "");
            config[2020605] = new SkillConfig(2020605, "分兵", "关羽", "", "术", 5, 0f, 6f, 18, "", 0, "", 60f, 25f, "", 1, 150f, 0.45f, 0, "", false, 0f, "", 1, 0f, 0f, 0f, 0, "SkillAidShadowSplit", "sway", "MagicChargeYellow", 0f, "guanyu", "", "", "");
            // ===== 姜维·流光 2020606~2020610（SkillAidDualLaser，法术 AOE）=====
            ...
            // ===== 夏侯惇·歼灭 2020611~2020615（SkillAidSmashStun，法术+眩晕）=====
            config[2020611] = new SkillConfig(2020611, "歼灭", "夏侯惇", "对目标造成/strength法术伤害并眩晕/bufftime秒", "术", 1, 0f, 6f, 14, "", 0, "", 50f, 0f, "", 0, 40f, 0f, 0, "乱", true, 1.2f, "", 0, 0f, 0f, 0f, 0, "SkillAidSmashStun", "sway", "MagicNovaBlue", 0f, "xiahoudun", "", "", "");
            config[2020612] = new SkillConfig(2020612, "歼灭", "夏侯惇", "", "术", 2, 0f, 6f, 14, "", 0, "", 50f, 0f, "", 0, 60f, 0f, 0, "乱", true, 1.4f, "", 0, 0f, 0f, 0f, 0, "SkillAidSmashStun", "sway", "MagicNovaBlue", 0f, "xiahoudun", "", "", "");
            config[2020613] = new SkillConfig(2020613, "歼灭", "夏侯惇", "", "术", 3, 0f, 6f, 14, "", 0, "", 50f, 0f, "", 0, 85f, 0f, 0, "乱", true, 1.6f, "", 0, 0f, 0f, 0f, 0, "SkillAidSmashStun", "sway", "MagicNovaBlue", 0f, "xiahoudun", "", "", "");
            config[2020614] = new SkillConfig(2020614, "歼灭", "夏侯惇", "", "术", 4, 0f, 6f, 14, "", 0, "", 50f, 0f, "", 0, 115f, 0f, 0, "乱", true, 1.8f, "", 0, 0f, 0f, 0f, 0, "SkillAidSmashStun", "sway", "MagicNovaBlue", 0f, "xiahoudun", "", "", "");
            config[2020615] = new SkillConfig(2020615, "歼灭", "夏侯惇", "", "术", 5, 0f, 6f, 14, "", 0, "", 50f, 0f, "", 0, 155f, 0f, 0, "乱", true, 2.0f, "", 0, 0f, 0f, 0f, 0, "SkillAidSmashStun", "sway", "MagicNovaBlue", 0f, "xiahoudun", "", "", "");
            // ===== 乐进·御斩 2020616~2020620（SkillAidSlashDefend，法术+自防）=====
            config[2020616] = new SkillConfig(2020616, "御斩", "乐进", "对目标造成/strength法术伤害，并为自身附加防御提升，持续/bufftime秒", "术", 1, 0f, 5f, 14, "", 0, "", 30f, 0f, "", 0, 40f, 0f, 0, "硬", false, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidSlashDefend", "sway", "MagicChargeYellow", 0f, "lejin", "", "", "");
            config[2020617] = new SkillConfig(2020617, "御斩", "乐进", "", "术", 2, 0f, 5f, 14, "", 0, "", 30f, 0f, "", 0, 60f, 0f, 0, "硬", false, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidSlashDefend", "sway", "MagicChargeYellow", 0f, "lejin", "", "", "");
            config[2020618] = new SkillConfig(2020618, "御斩", "乐进", "", "术", 3, 0f, 5f, 14, "", 0, "", 30f, 0f, "", 0, 85f, 0f, 0, "硬", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidSlashDefend", "sway", "MagicChargeYellow", 0f, "lejin", "", "", "");
            config[2020619] = new SkillConfig(2020619, "御斩", "乐进", "", "术", 4, 0f, 5f, 14, "", 0, "", 30f, 0f, "", 0, 115f, 0f, 0, "硬", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidSlashDefend", "sway", "MagicChargeYellow", 0f, "lejin", "", "", "");
            config[2020620] = new SkillConfig(2020620, "御斩", "乐进", "", "术", 5, 0f, 5f, 14, "", 0, "", 30f, 0f, "", 0, 155f, 0f, 0, "硬", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidSlashDefend", "sway", "MagicChargeYellow", 0f, "lejin", "", "", "");
            // ===== 程普·横扫 2020621~2020625（SkillAidBashShield，法术范围+自盾）=====
            config[2020621] = new SkillConfig(2020621, "横扫", "程普", "挺戟横扫，对/area范围内的敌人造成/strength法术伤害，并获得/strength2%最大生命的护盾", "术", 1, 0f, 5f, 14, "", 0, "", 0f, 20f, "", 3, 28f, 0.15f, 0, "盾", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBashShield", "sway", "MagicChargeYellow", 0f, "chengpu", "", "", "");
            config[2020622] = new SkillConfig(2020622, "横扫", "程普", "", "术", 2, 0f, 5f, 14, "", 0, "", 0f, 20f, "", 3, 42f, 0.20f, 0, "盾", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBashShield", "sway", "MagicChargeYellow", 0f, "chengpu", "", "", "");
            config[2020623] = new SkillConfig(2020623, "横扫", "程普", "", "术", 3, 0f, 5f, 14, "", 0, "", 0f, 20f, "", 3, 62f, 0.25f, 0, "盾", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBashShield", "sway", "MagicChargeYellow", 0f, "chengpu", "", "", "");
            config[2020624] = new SkillConfig(2020624, "横扫", "程普", "", "术", 4, 0f, 5f, 14, "", 0, "", 0f, 20f, "", 3, 88f, 0.30f, 0, "盾", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBashShield", "sway", "MagicChargeYellow", 0f, "chengpu", "", "", "");
            config[2020625] = new SkillConfig(2020625, "横扫", "程普", "", "术", 5, 0f, 5f, 14, "", 0, "", 0f, 20f, "", 3, 120f, 0.35f, 0, "盾", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBashShield", "sway", "MagicChargeYellow", 0f, "chengpu", "", "", "");
            // ===== 颜良·斩杀 2020626~2020630（SkillAidExecute，法术斩杀）=====
            config[2020626] = new SkillConfig(2020626, "斩杀", "颜良", "对目标造成/strength法术伤害；若目标生命低于/strengthint%，伤害提升至/strength2倍", "术", 1, 0f, 6f, 18, "", 0, "", 50f, 0f, "", 0, 45f, 1.5f, 30, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidExecute", "sway", "MagicNovaBlue", 0f, "yanliang", "", "", "");
            config[2020627] = new SkillConfig(2020627, "斩杀", "颜良", "", "术", 2, 0f, 6f, 18, "", 0, "", 50f, 0f, "", 0, 70f, 1.6f, 30, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidExecute", "sway", "MagicNovaBlue", 0f, "yanliang", "", "", "");
            config[2020628] = new SkillConfig(2020628, "斩杀", "颜良", "", "术", 3, 0f, 6f, 18, "", 0, "", 50f, 0f, "", 0, 100f, 1.7f, 30, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidExecute", "sway", "MagicNovaBlue", 0f, "yanliang", "", "", "");
            config[2020629] = new SkillConfig(2020629, "斩杀", "颜良", "", "术", 4, 0f, 6f, 18, "", 0, "", 50f, 0f, "", 0, 135f, 1.8f, 30, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidExecute", "sway", "MagicNovaBlue", 0f, "yanliang", "", "", "");
            config[2020630] = new SkillConfig(2020630, "斩杀", "颜良", "", "术", 5, 0f, 6f, 18, "", 0, "", 50f, 0f, "", 0, 180f, 2.0f, 30, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidExecute", "sway", "MagicNovaBlue", 0f, "yanliang", "", "", "");
            // ===== 马超·追猎 2020631~2020635（SkillAidRandomCombo，法术随机连击）=====
            config[2020631] = new SkillConfig(2020631, "追猎", "马超", "疯狂追击目标/summoncount至/strengthint次，每次造成/strength法术伤害，次数随机", "术", 1, 0f, 5f, 16, "", 0, "", 60f, 0f, "", 0, 15f, 0f, 4, "", false, 0f, "", 2, 0f, 0f, 0f, 0, "SkillAidRandomCombo", "sway", "MagicNovaBlue", 0f, "machao", "", "", "");
            config[2020632] = new SkillConfig(2020632, "追猎", "马超", "", "术", 2, 0f, 5f, 16, "", 0, "", 60f, 0f, "", 0, 20f, 0f, 4, "", false, 0f, "", 2, 0f, 0f, 0f, 0, "SkillAidRandomCombo", "sway", "MagicNovaBlue", 0f, "machao", "", "", "");
            config[2020633] = new SkillConfig(2020633, "追猎", "马超", "", "术", 3, 0f, 5f, 16, "", 0, "", 60f, 0f, "", 0, 25f, 0f, 5, "", false, 0f, "", 2, 0f, 0f, 0f, 0, "SkillAidRandomCombo", "sway", "MagicNovaBlue", 0f, "machao", "", "", "");
            config[2020634] = new SkillConfig(2020634, "追猎", "马超", "", "术", 4, 0f, 5f, 16, "", 0, "", 60f, 0f, "", 0, 30f, 0f, 5, "", false, 0f, "", 2, 0f, 0f, 0f, 0, "SkillAidRandomCombo", "sway", "MagicNovaBlue", 0f, "machao", "", "", "");
            config[2020635] = new SkillConfig(2020635, "追猎", "马超", "", "术", 5, 0f, 5f, 16, "", 0, "", 60f, 0f, "", 0, 40f, 0f, 6, "", false, 0f, "", 3, 0f, 0f, 0f, 0, "SkillAidRandomCombo", "sway", "MagicNovaBlue", 0f, "machao", "", "", "");
            // ===== 曹彰·疾攻 2020636~2020640（SkillAidHasteStrike，法术+自翼）=====
            config[2020636] = new SkillConfig(2020636, "疾攻", "曹彰", "对目标造成/strength法术伤害，并获得攻速与移速提升，持续/bufftime秒", "术", 1, 0f, 4f, 14, "", 0, "", 50f, 0f, "", 0, 30f, 0f, 0, "翼", false, 3f, "", 0, 0f, 0f, 0f, 0, "SkillAidHasteStrike", "sway", "MagicChargeYellow", 0f, "caozhang", "", "", "");
            config[2020637] = new SkillConfig(2020637, "疾攻", "曹彰", "", "术", 2, 0f, 4f, 14, "", 0, "", 50f, 0f, "", 0, 45f, 0f, 0, "翼", false, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidHasteStrike", "sway", "MagicChargeYellow", 0f, "caozhang", "", "", "");
            config[2020638] = new SkillConfig(2020638, "疾攻", "曹彰", "", "术", 3, 0f, 4f, 14, "", 0, "", 50f, 0f, "", 0, 65f, 0f, 0, "翼", false, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidHasteStrike", "sway", "MagicChargeYellow", 0f, "caozhang", "", "", "");
            config[2020639] = new SkillConfig(2020639, "疾攻", "曹彰", "", "术", 4, 0f, 4f, 14, "", 0, "", 50f, 0f, "", 0, 90f, 0f, 0, "翼", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidHasteStrike", "sway", "MagicChargeYellow", 0f, "caozhang", "", "", "");
            config[2020640] = new SkillConfig(2020640, "疾攻", "曹彰", "", "术", 5, 0f, 4f, 14, "", 0, "", 50f, 0f, "", 0, 120f, 0f, 0, "翼", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidHasteStrike", "sway", "MagicChargeYellow", 0f, "caozhang", "", "", "");
            // ===== 朱桓·标记 2020641~2020645（SkillAidMarkTarget，法术+易伤）=====
            config[2020641] = new SkillConfig(2020641, "标记", "朱桓", "对目标造成/strength法术伤害，并使其受到的伤害提升/strength2%，持续/bufftime秒", "术", 1, 0f, 5f, 14, "", 0, "", 50f, 0f, "", 0, 25f, 0.15f, 0, "伤", true, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidMarkTarget", "sway", "MagicNovaBlue", 0f, "zhuhuan", "", "", "");
            config[2020642] = new SkillConfig(2020642, "标记", "朱桓", "", "术", 2, 0f, 5f, 14, "", 0, "", 50f, 0f, "", 0, 40f, 0.20f, 0, "伤", true, 4f, "", 0, 0f, 0f, 0f, 0, "SkillAidMarkTarget", "sway", "MagicNovaBlue", 0f, "zhuhuan", "", "", "");
            config[2020643] = new SkillConfig(2020643, "标记", "朱桓", "", "术", 3, 0f, 5f, 14, "", 0, "", 50f, 0f, "", 0, 58f, 0.25f, 0, "伤", true, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidMarkTarget", "sway", "MagicNovaBlue", 0f, "zhuhuan", "", "", "");
            config[2020644] = new SkillConfig(2020644, "标记", "朱桓", "", "术", 4, 0f, 5f, 14, "", 0, "", 50f, 0f, "", 0, 82f, 0.30f, 0, "伤", true, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidMarkTarget", "sway", "MagicNovaBlue", 0f, "zhuhuan", "", "", "");
            config[2020645] = new SkillConfig(2020645, "标记", "朱桓", "", "术", 5, 0f, 5f, 14, "", 0, "", 50f, 0f, "", 0, 112f, 0.35f, 0, "伤", true, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidMarkTarget", "sway", "MagicNovaBlue", 0f, "zhuhuan", "", "", "");
            // ===== 韩当·双射 2020646~2020650（SkillAidDoubleShot，法术双射）=====
            config[2020646] = new SkillConfig(2020646, "双射", "韩当", "对目标及附近/targetcount-1名敌人各造成/strength法术伤害", "术", 1, 0f, 5f, 14, "", 0, "", 60f, 25f, "", 2, 32f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidDoubleShot", "shoot", "", 0f, "handang", "", "", "");
            config[2020647] = new SkillConfig(2020647, "双射", "韩当", "", "术", 2, 0f, 5f, 14, "", 0, "", 60f, 25f, "", 2, 50f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidDoubleShot", "shoot", "", 0f, "handang", "", "", "");
            config[2020648] = new SkillConfig(2020648, "双射", "韩当", "", "术", 3, 0f, 5f, 14, "", 0, "", 60f, 25f, "", 2, 72f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidDoubleShot", "shoot", "", 0f, "handang", "", "", "");
            config[2020649] = new SkillConfig(2020649, "双射", "韩当", "", "术", 4, 0f, 5f, 14, "", 0, "", 60f, 25f, "", 2, 100f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidDoubleShot", "shoot", "", 0f, "handang", "", "", "");
            config[2020650] = new SkillConfig(2020650, "双射", "韩当", "", "术", 5, 0f, 5f, 14, "", 0, "", 60f, 25f, "", 2, 135f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidDoubleShot", "shoot", "", 0f, "handang", "", "", "");
            // ===== 华雄·狂暴 2020651~2020655（SkillAidBerserk，法术双刃剑）=====
            config[2020651] = new SkillConfig(2020651, "狂暴", "华雄", "进入狂暴状态，造成的伤害提升/strength2%，但同时受到的伤害提升/strength2%，持续/bufftime秒", "术", 1, 0f, 6f, 14, "", 0, "", 0f, 0f, "", 0, 0f, 0.20f, 0, "狂", false, 5f, "", 0, 0f, 0f, 0f, 0, "SkillAidBerserk", "sway", "MagicChargeYellow", 0f, "huaxiong", "", "", "");
            config[2020652] = new SkillConfig(2020652, "狂暴", "华雄", "", "术", 2, 0f, 6f, 14, "", 0, "", 0f, 0f, "", 0, 0f, 0.25f, 0, "狂", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBerserk", "sway", "MagicChargeYellow", 0f, "huaxiong", "", "", "");
            config[2020653] = new SkillConfig(2020653, "狂暴", "华雄", "", "术", 3, 0f, 6f, 14, "", 0, "", 0f, 0f, "", 0, 0f, 0.30f, 0, "狂", false, 6f, "", 0, 0f, 0f, 0f, 0, "SkillAidBerserk", "sway", "MagicChargeYellow", 0f, "huaxiong", "", "", "");
            config[2020654] = new SkillConfig(2020654, "狂暴", "华雄", "", "术", 4, 0f, 6f, 14, "", 0, "", 0f, 0f, "", 0, 0f, 0.35f, 0, "狂", false, 7f, "", 0, 0f, 0f, 0f, 0, "SkillAidBerserk", "sway", "MagicChargeYellow", 0f, "huaxiong", "", "", "");
            config[2020655] = new SkillConfig(2020655, "狂暴", "华雄", "", "术", 5, 0f, 6f, 14, "", 0, "", 0f, 0f, "", 0, 0f, 0.40f, 0, "狂", false, 7f, "", 0, 0f, 0f, 0f, 0, "SkillAidBerserk", "sway", "MagicChargeYellow", 0f, "huaxiong", "", "", "");
            // ===== 陈泰·换位 2020656~2020660（SkillAidSwapStrike，法术+换位）=====
            config[2020656] = new SkillConfig(2020656, "换位", "陈泰", "与目标交换位置，并对其造成/strength法术伤害", "术", 1, 0f, 6f, 25, "", 0, "", 50f, 0f, "", 0, 50f, 0f, 0, "", false, 0f, "", 0, 0f, 0f, 0f, 0, "SkillAidSwapStrike", "sway", "MagicNovaBlue", 0f, "chentai", "", "", "");
