...
namespace CommonConfig
{
    public class HeroFriendConfig
    {
        ...
        {
            config.Clear();
            config[1] = new HeroFriendConfig(1, "桃源结义", 2, new int[]{100001,101002,101005});
            config[2] = new HeroFriendConfig(2, "五虎上将", 1, new int[]{101001,101002,101003,101005,101008});
            config[3] = new HeroFriendConfig(3, "师徒护汉", 2, new int[]{101004,101010});
            ...
            config[6] = new HeroFriendConfig(6, "关式虎将", 2, new int[]{101005,101013,101012,101021});
            config[7] = new HeroFriendConfig(7, "张氏父子", 2, new int[]{101002,101019});
            config[8] = new HeroFriendConfig(8, "孔明夫妻", 2, new int[]{101004,101032});
            config[9] = new HeroFriendConfig(9, "南蛮夫妻", 2, new int[]{101016,101035});
            ...
            config[19] = new HeroFriendConfig(19, "江东基业", 1, new int[]{103001,103002,100003});
            config[20] = new HeroFriendConfig(20, "江表老臣", 1, new int[]{103005,103024,103029});
            config[21] = new HeroFriendConfig(21, "江东虎臣", 1, new int[]{103009,103006,103019,103034});
            config[22] = new HeroFriendConfig(22, "都督传承", 1, new int[]{103008,103010,103011});
            config[23] = new HeroFriendConfig(23, "瑜策", 2, new int[]{103002,103008});
            config[24] = new HeroFriendConfig(24, "二乔", 2, new int[]{103016,103017});
            config[25] = new HeroFriendConfig(25, "帆箭", 2, new int[]{103003,103004});
            config[26] = new HeroFriendConfig(26, "陆氏父子", 2, new int[]{103011,103030});
            config[27] = new HeroFriendConfig(27, "吕布帐下", 1, new int[]{104001,104006,104005});
            config[28] = new HeroFriendConfig(28, "河北庭柱", 1, new int[]{106006,106001,106002,102008});
            config[29] = new HeroFriendConfig(29, "黄巾之乱", 1, new int[]{110007,110008,110009});
            config[30] = new HeroFriendConfig(30, "司马家族", 2, new int[]{105002,105003,100005,102018});
            config[31] = new HeroFriendConfig(31, "西晋名将", 1, new int[]{105001,105005,105008});
            config[32] = new HeroFriendConfig(32, "英雄美人", 2, new int[]{104001,104004});
            config[33] = new HeroFriendConfig(33, "英雄相惜", 2, new int[]{101005,102004});
            config[34] = new HeroFriendConfig(34, "汉寿之恩", 2, new int[]{100002,101005});
            ...
            config[39] = new HeroFriendConfig(39, "祁山斗智", 2, new int[]{101004,102018});
            config[40] = new HeroFriendConfig(40, "神亭酣战", 2, new int[]{103002,103004});
            config[41] = new HeroFriendConfig(41, "定军扬威", 2, new int[]{101033,101008});
            config[42] = new HeroFriendConfig(42, "北征帷幄", 2, new int[]{102001,102004});
            config[43] = new HeroFriendConfig(43, "雍凉屏障", 2, new int[]{102018,102035});
            config[44] = new HeroFriendConfig(44, "平吴先锋", 2, new int[]{105007,105008});
            config[45] = new HeroFriendConfig(45, "苦肉献策", 2, new int[]{103008,103028,103005});
            config[46] = new HeroFriendConfig(46, "有勇有谋", 2, new int[]{104001,104010});
            config[47] = new HeroFriendConfig(47, "官渡奇谋", 2, new int[]{106005,100002});
            config[48] = new HeroFriendConfig(48, "灭蜀之功", 2, new int[]{105003,105001});
            config[49] = new HeroFriendConfig(49, "舟楫平吴", 2, new int[]{105004,105007,100005});
            config[50] = new HeroFriendConfig(50, "合肥同心", 2, new int[]{102004,102028});
            config[51] = new HeroFriendConfig(51, "凤仪亭", 2, new int[]{100004,104001});
            ...
            config[57] = new HeroFriendConfig(57, "蜀汉同盟", 3, new int[]{100001,103014});
            config[58] = new HeroFriendConfig(58, "荀氏叔侄", 2, new int[]{102003,102010});
            ...
            config[63] = new HeroFriendConfig(63, "托孤大臣", 2, new int[]{101023,101025,101027,101030});
            config[64] = new HeroFriendConfig(64, "祸乱长安", 1, new int[]{104008,104009,104003});
            config[65] = new HeroFriendConfig(65, "将门虎子", 2, new int[]{101012,101019});
            ...
            config[70] = new HeroFriendConfig(70, "川蜀集团", 1, new int[]{101033,101020,101036,101018});
            ...
            config[76] = new HeroFriendConfig(76, "淮南骁将", 2, new int[]{102034,102025});
            config[77] = new HeroFriendConfig(77, "扛刀牵马", 3, new int[]{101005,101009});
            config[78] = new HeroFriendConfig(78, "蜀汉先锋", 2, new int[]{101015,101010});
            config[79] = new HeroFriendConfig(79, "刘备旧部", 2, new int[]{101022,101024});
            ...
            config[84] = new HeroFriendConfig(84, "钟氏父子", 2, new int[]{102037,105005});
            config[85] = new HeroFriendConfig(85, "江东屏障", 2, new int[]{103015,103006});
            config[86] = new HeroFriendConfig(86, "毒士枭雄", 2, new int[]{104007,100004});
            config[87] = new HeroFriendConfig(87, "陈氏父子", 2, new int[]{105006,102027});
            config[88] = new HeroFriendConfig(88, "卢门同窗", 2, new int[]{110001,100001});
            config[89] = new HeroFriendConfig(89, "白马白卫", 2, new int[]{110001,101001});
            config[90] = new HeroFriendConfig(90, "东吴栋梁", 2, new int[]{103027,103026,103038});
            ...
            config[96] = new HeroFriendConfig(96, "讨董联盟", 2, new int[]{100002,103001,100006,110004,110005});
