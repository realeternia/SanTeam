...
public class PlayerBook
{
    ...
    {
        // 低级叠卡
        playerCfgDic[2] = new PlayerCfg() { id = 2, name = "甲鱼", imgPath = "PlayerPic/jiayu", aiConfig = new AICardConfig() { banRangeCard = true, banStrongCard = true, priceLower = 15, priceUpper = 18, sameCardRate = 5f, cardLimit = 8, futureRate = 0.7f, priceOutRate = 0.1f } };

        // 默认ai
        playerCfgDic[3] = new PlayerCfg() { id = 3, name = "三哥", imgPath = "PlayerPic/sange", aiConfig = new AICardConfig() { cardLimit = 9, } };


        playerCfgDic[4] = new PlayerCfg() { id = 4, name = "魔童", imgPath = "PlayerPic/nezha", aiConfig = new AICardConfig() { banCombatCard = true, banWeakCard = true, pickInteCardRate = 3f } };


        playerCfgDic[5] = new PlayerCfg() { id = 5, name = "八戒", imgPath = "PlayerPic/bajie", aiConfig = new AICardConfig() { banCombatCard = true, banStrongCard = true, cardLimit = 9, pickRangeCardRate = 2.5f, pickInteCardRate = 2.5f, } };


        // 高级叠卡
        playerCfgDic[6] = new PlayerCfg() { id = 6, name = "大虎", imgPath = "PlayerPic/dahu", aiConfig = new AICardConfig() { banRangeCard = true, banWeakCard = true, priceLower = 20, priceUpper = 33, sameCardRate = 5f, futureRate = 0.6f, priceOutRate = 0.1f, } };


        // 曹操流
        playerCfgDic[7] = new PlayerCfg() { id = 7, name = "蓝猫", imgPath = "PlayerPic/mao", aiConfig = new AICardConfig() { banWeakCard = true,pickSide = 2, findMasterRate = 2.5f, } };
        ...
        // 刘备
        playerCfgDic[12] = new PlayerCfg() { id = 12, name = "电怪", imgPath = "PlayerPic/picaqiu", aiConfig = new AICardConfig() { banWeakCard = true, pickSide = 1, findMasterRate = 3f, } };
