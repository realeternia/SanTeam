...
public class PlayerBook
{
    ...
    {
        // 低级叠卡
        playerCfgDic[2] = new PlayerCfg() { id = 2, name = "甲鱼", imgPath = "PlayerPic/jiayu", colorStr = "#333333", aiConfig = new AICardConfig() { banRangeCard = true, banStrongCard = true, priceLower = 15, priceUpper = 18, sameCardRate = 5f, cardLimit = 8, futureRate = 0.7f, priceOutRate = 0.1f } };
        ...
        playerCfgDic[5] = new PlayerCfg() { id = 5, name = "八戒", imgPath = "PlayerPic/bajie", colorStr = "#FFCC99", aiConfig = new AICardConfig() { banCombatCard = true, banStrongCard = true, cardLimit = 9, pickRangeCardRate = 2.5f, pickInteCardRate = 2.5f, } };


        // 高级叠卡
        playerCfgDic[6] = new PlayerCfg() { id = 6, name = "大虎", imgPath = "PlayerPic/dahu", colorStr = "#006633", aiConfig = new AICardConfig() { banRangeCard = true, banWeakCard = true, priceLower = 20, priceUpper = 33, sameCardRate = 5f, futureRate = 0.6f, priceOutRate = 0.1f, } };
        ...
        // 默认ai
        playerCfgDic[8] = new PlayerCfg() { id = 8, name = "巴爸", imgPath = "PlayerPic/baba", colorStr = "#FF73FF", aiConfig = new AICardConfig() { futureRate = 0.2f, cardLimit = 9, } };

        playerCfgDic[9] = new PlayerCfg() { id = 9, name = "蜘蛛", imgPath = "PlayerPic/zhizhu", colorStr = "#FF0000", aiConfig = new AICardConfig() {  cardLimit = 11, futureRate = 0.25f, } };
        ...
        // 刘备
        playerCfgDic[12] = new PlayerCfg() { id = 12, name = "电怪", imgPath = "PlayerPic/picaqiu", colorStr = "#FFFF00", aiConfig = new AICardConfig() { banWeakCard = true, pickSide = 1, findMasterRate = 3f, } };
