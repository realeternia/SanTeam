...
public class PlayerBook
{
    ...
    {
        // 低级叠卡
        playerCfgDic[2] = new PlayerCfg() {
            id = 2,
            name = "甲鱼",
            imgPath = "PlayerPic/jiayu",
            aiConfig = new AICardConfig()
            {
                priceLower = 8,
                priceUpper = 11,
                sameCardRate = 5f,
        ...
        // 默认ai
        playerCfgDic[3] = new PlayerCfg() { id = 3, name = "三哥", imgPath = "PlayerPic/sange", aiConfig = new AICardConfig() { cardLimit = 10, } };
        ...
        // 高级叠卡
        playerCfgDic[6] = new PlayerCfg() { id = 6, name = "大虎", imgPath = "PlayerPic/dahu", aiConfig = new AICardConfig() { priceLower = 9, priceUpper = 13, sameCardRate = 5f, cardLimit = 7, futureRate = 0.6f, priceOutRate = 0.1f,} };
        ...
        playerCfgDic[9] = new PlayerCfg() { id = 9, name = "蜘蛛", imgPath = "PlayerPic/zhizhu", aiConfig = new AICardConfig() { cardLimit = 12, futureRate = 0.25f, } };
