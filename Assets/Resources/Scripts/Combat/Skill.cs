...
public class Skill
{
    ...
    public virtual void OnAddBuff(BuffConfig buffCfg, int skillId, ref float time)
    {
    ...
    public virtual void OnBeAddBuff(BuffConfig buffCfg, int checkSkillId, ref float time)
    {
