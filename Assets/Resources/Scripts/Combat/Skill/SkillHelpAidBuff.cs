...
public class SkillHelpAidBuff : Skill
{
    ...
    public override bool CheckAidSkill()
    {
        ...
        unitsInRange = unitsInRange.FindAll(x => x != owner && x.IsInFight() && !x.HasBuff(BuffConfig.GetConfigByNameS(skillCfg.BuffId).Id));
        ...
        BuffManager.AddBuff(targetUnit, owner, id, BuffConfig.GetConfigByNameS(skillCfg.BuffId).Id, skillCfg.BuffTime);
